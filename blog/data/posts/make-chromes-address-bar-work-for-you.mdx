...
date: '2021-10-11'
lastmod: '2021-10-11'
tags: ['Chrome', 'Tips and tricks']
readingList: []
draft: false
summary: 'Google Chrome shortcuts to save you some time'
images: ['/static/images/blog/google.jpg']
---

<InlineImage
  src="/static/images/blog/google.jpg"
...
![GIF showing how to use the weather shortcut](/static/images/blog/contents/1_WhDf2fRg6oC9sErwE5NBMQ.gif)
...
![GIF showing how to use the conversion shortcut](/static/images/blog/contents/1_RLi3LV8s-RIsQLZL1PacwQ.gif)

Image provided by the author

In fact, there's a whole bunch of conversions you can try like centimetres to meters, feet to inches, etc.

![GIF showing how to use the conversion shortcut](/static/images/blog/contents/1_Hdks3FfUC6UoaL5TriW3sw.gif)
...
![GIF showing how to use the Math shortcut](/static/images/blog/contents/1_wHrJFziqizt9wxUWlKyCxg.gif)
...
![GIF showing how to use complex Math shortcuts](/static/images/blog/contents/1_PA7b5TiX6BgWVMhDb7Wf0w.gif)
...
![GIF showing how to use the share price ticker shortcut](/static/images/blog/contents/1_GbX1FUav8VcFhE-2jwPTDA.gif)
...
![GIF showing how to use the foreign exchange calculation shortcut](/static/images/blog/contents/1_lDgN88UF4fqp7mmR1ZBzjA.gif)
...
![GIF showing how to use the translation shortcut](/static/images/blog/contents/1_oGl-rPaH_HrVBXJbkxgXAg.gif)
...
![GIF showing how to use the sunset/sunrise shortcut](/static/images/blog/contents/1_f1jeslkZsWq81GAkAJLgCw.gif)
...
![GIF showing how to use the definition/meaning shortcut](/static/images/blog/contents/1_RuH9YtUdP_Eo-aAXPpo9dg.gif)
...
![GIF showing how to use the holiday shortcut](/static/images/blog/contents/1_PJD_Op9B2KEcQSLTfU1LOQ.gif)
...
![GIF showing how to use the general knowledge/search shortcut](/static/images/blog/contents/1_lS9qsmqxaIGHkrpWSFS8PQ.gif)
...
_Get an email whenever Clyde D'Souza publishes. By signing up, you will create a Medium account if you don't already…_&#x63;lydedz.medium.com](https://clydedz.medium.com/subscribe 'https://clydedz.medium.com/subscribe')[](https://clydedz.medium.com/subscribe)
