...
date: '2020-03-31'
lastmod: '2020-03-31'
tags: ['Chrome', 'Writing', 'Technical Support', 'Writing Life', 'Spelling']
readingList: ['Google Chrome']
draft: false
images: ['/static/posts/chrome.png']
---

<InlineImage
  src="/static/posts/chrome.png"
...
![Sample story with spellcheck errors using American English dictionary](/static/posts/1_fFpj9bCBeg3jYuv66f6gRg.png)

Caption: Sample story with spell check errors using American English dictionary
...
![Adding a new language preference to Chrome settings](/static/posts/1_0naFALHTvo2JrYXu-BECng.gif)

Caption: Adding a new language preference to Chrome settings
...
![Toggle spell check for only a selected language in Chrome settings](/static/posts/1_NA3JDcoh_Z3haN8ufKkT5w.gif)

Caption: Toggle spell check for only a selected language in Chrome settings
...
![Sample story without any spell check errors](/static/posts/1_xy4RVAs0PmKoCizH86yIqg.png)
