...
images: ['/static/images/blog/twitch.png']
---

<InlineImage
  src="/static/images/blog/twitch.png"
...
![Finding Video Producer from Twitch settings.](https://cdn-images-1.medium.com/max/800/1*g6fPTMzyh8WgiR2jFNlO4A.png)
...
![Editing stream info in Twitch’s creator dashboard.](https://cdn-images-1.medium.com/max/800/1*3b-TrvvWd0PKXuon0eq6EQ.png)
...
![Finding settings menu in Twitch.](https://cdn-images-1.medium.com/max/800/1*fmGUqGTHToCGr5Es9SEBUg.png)

Now, click on **Channel and Videos**.

![Clicking on channel and videos menu item in Twitch.](https://cdn-images-1.medium.com/max/800/1*4Muk5-mPRLk-tWn3pJA_Sg.png)
...
![Copying the stream key from Twitch.](https://cdn-images-1.medium.com/max/800/1*wpENUx3vPvTpsMlIX2bvhA.png)
...
![Downloading the essentials FFmpeg build.](https://cdn-images-1.medium.com/max/800/1*xqt-D6LNVngX_R5POg8PVQ.png)
...
![Validating that FFmpeg exists in the bin folder.](https://cdn-images-1.medium.com/max/800/1*5O5hYrjaUK7-R6YalTOOPg.png)
...
![Editing system environment variables.](https://cdn-images-1.medium.com/max/800/1*xhLRrq5l5Y8RZuKpidvO9w.png)

Then, from the **System Properties&#x20;**&#x77;indow, click on the **Environment Variables…** button at the bottom.

![Clicking on environment variables button from System Properties.](https://cdn-images-1.medium.com/max/800/1*0LVDA4SBqDMO-uMdqyUOVw.png)

From the **Environment Variables** screen, double-click on **Path**.

![Adding FFmpeg application’s path to environment variables.](https://cdn-images-1.medium.com/max/800/1*cCJNmzNrYShmWz1UWenbtA.png)
...
![Adding FFmpeg’s executable path to environment variables.](https://cdn-images-1.medium.com/max/800/1*xn3prNiFqET6veMJ33uzBg.png)
...
![Testing FFmpeg command.](https://cdn-images-1.medium.com/max/800/1*r1JilO0wSvB0aEYP5I6OrA.png)
...
![List of Twitch ingest endpoints.](https://cdn-images-1.medium.com/max/800/1*tbvwqpoh9nYbTyJh93HgFg.png)
...
![Opening command prompt via the file explorer.](https://cdn-images-1.medium.com/max/800/1*5G0jTD3PYRdrpSMMnpTzTg.gif)

Now, type the command as mentioned in step 4. Here’s an example of the command I used.

![Command to execute to live-stream your video.](https://cdn-images-1.medium.com/max/800/1*H79BC1oYEL4vpiiHaTS_Nw.png)

Hit enter and you should see some progress. And in just a few moments, the live video should start playing in Twitch.

![Progress of the command after executing.](https://cdn-images-1.medium.com/max/800/1*9j8IeQ1ZB13e-YcGtqmbBA.png)
