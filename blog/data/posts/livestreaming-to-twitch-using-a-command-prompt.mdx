...
![Finding Video Producer from Twitch settings.](/static/images/blog/contents/1_g6fPTMzyh8WgiR2jFNlO4A.png)
...
![Editing stream info in Twitch’s creator dashboard.](/static/images/blog/contents/1_3b-TrvvWd0PKXuon0eq6EQ.png)
...
![Finding settings menu in Twitch.](/static/images/blog/contents/1_fmGUqGTHToCGr5Es9SEBUg.png)

Now, click on **Channel and Videos**.

![Clicking on channel and videos menu item in Twitch.](/static/images/blog/contents/1_4Muk5-mPRLk-tWn3pJA_Sg.png)
...
![Copying the stream key from Twitch.](/static/images/blog/contents/1_wpENUx3vPvTpsMlIX2bvhA.png)
...
![Downloading the essentials FFmpeg build.](/static/images/blog/contents/1_xqt-D6LNVngX_R5POg8PVQ.png)
...
![Validating that FFmpeg exists in the bin folder.](/static/images/blog/contents/1_5O5hYrjaUK7-R6YalTOOPg.png)
...
![Editing system environment variables.](/static/images/blog/contents/1_xhLRrq5l5Y8RZuKpidvO9w.png)

Then, from the **System Properties&#x20;**&#x77;indow, click on the **Environment Variables…** button at the bottom.

![Clicking on environment variables button from System Properties.](/static/images/blog/contents/1_0LVDA4SBqDMO-uMdqyUOVw.png)

From the **Environment Variables** screen, double-click on **Path**.

![Adding FFmpeg application’s path to environment variables.](/static/images/blog/contents/1_cCJNmzNrYShmWz1UWenbtA.png)
...
![Adding FFmpeg’s executable path to environment variables.](/static/images/blog/contents/1_xn3prNiFqET6veMJ33uzBg.png)
...
![Testing FFmpeg command.](/static/images/blog/contents/1_r1JilO0wSvB0aEYP5I6OrA.png)
...
![List of Twitch ingest endpoints.](/static/images/blog/contents/1_tbvwqpoh9nYbTyJh93HgFg.png)
...
![Opening command prompt via the file explorer.](/static/images/blog/contents/1_5G0jTD3PYRdrpSMMnpTzTg.gif)

Now, type the command as mentioned in step 4. Here’s an example of the command I used.

![Command to execute to live-stream your video.](/static/images/blog/contents/1_H79BC1oYEL4vpiiHaTS_Nw.png)

Hit enter and you should see some progress. And in just a few moments, the live video should start playing in Twitch.

![Progress of the command after executing.](/static/images/blog/contents/1_9j8IeQ1ZB13e-YcGtqmbBA.png)
