...
<InlineImage
  ...
  caption={
    <>
      Image source <a href="">Unsplash</a> caption
    </>
  }
/>
...
<YouTube url="https://www.youtube.com/watch?v=ekBaLP2iIGo" />

## Gist

<iframe
  src={`https://gist.github.com/ClydeDz/7b024e6457988344b7c1aeff2279fae2.pibb`}
  width="100%"
  height="100%"
/>

<script src="https://gist.github.com/ClydeDz/7b024e6457988344b7c1aeff2279fae2.js"></script>

Contentlayer then processes the MDX files with our desired markdown remark or rehype plugins,
validates the schema, generate type definitions and output json files that can be easily imported in
our pages. Hot reloading comes out of the box, so edits to the markdown files will be reflected in
