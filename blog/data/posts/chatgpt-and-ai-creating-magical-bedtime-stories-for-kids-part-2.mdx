...
draft: false
summary: 'Part 2: A Step-by-Step Guide to Writing, Cover Designing, and Publishing a Children’s Storybook with Artificial Intelligence on Your Side'
...
![A screenshot of how to import a Microsoft Word file into Kindle Create](/static/images/blog/contents/1_85UEcBfuhApHx9MDvjxfdg.png)

Image courtesy of the author

Click on the **Choose File (.doc, .docx)** button to open up a modal to select your Word document.

![A screenshot of how to import a Microsoft Word file into Kindle Create.](/static/images/blog/contents/1_Yi0HqV5yVmBKPqDdXKoPIw.png)

Image courtesy of the author

Import the document and accept the chapter titles that Kindle Create automatically detects.

![A screenshot of how Kindle Create automatically detects page titles in a book.](/static/images/blog/contents/1_02lH6M0FyR9TfQ83_Vx6_w.png)
...
![A screenshot showing how to add a title page in Kindle Create.](/static/images/blog/contents/1_YnGbTm9y0Jp26GJnd94MtA.png)
...
![A screenshot of updating the title page in Kindle Create](/static/images/blog/contents/1_U0W4NcMwbNQYXDuhrNuDMw.png)
...
![A screenshot of deleting a section in Kindle Create.](/static/images/blog/contents/1_12iq1FYnvazBKxmBeedjgA.png)
...
![](/static/images/blog/contents/1_a1OcxPgZLPeZNRcfkhjWGw.png)
...
![](/static/images/blog/contents/1_UjDMSY6VdSv4obwU4c91Dw.png)

Image courtesy of the author

Then, delete the original copyright page from the **Body** section.

![](/static/images/blog/contents/1_5e6FpuC-EyvBGdZyM-j3KQ.png)
...
![](/static/images/blog/contents/1_CoSBqpYEZeHqMkgMwxfOCg.png)

Image courtesy of the author

Next, from the **Front Matter** section, add **Table of Contents**.

![](/static/images/blog/contents/1_Kn351Vd0trQywTIRWX6uBw.png)
...
![](/static/images/blog/contents/1_txl_NUmW3NWdFc3Os-HzGA.png)
...
![](/static/images/blog/contents/1_jGzke71iZh_NBo1SIvfC9g.png)
...
![](/static/images/blog/contents/1_Dja6mUfWxmMhKPS1nz8jzQ.png)
...
![](/static/images/blog/contents/1_AMkAq967sLF_sL3mps9HTw.png)
...
![](/static/images/blog/contents/1_eIFSKF5ZBHCTHtW_O92cxQ.png)
...
![](/static/images/blog/contents/1_vWiO1c1nPJiQiO5HhBhuYw.png)

Image courtesy of the author

Next up, we can add a **Books By This Author** section if you have an existing book(s) published.

![](/static/images/blog/contents/1_bh9JDntI1SmIlO1zfaEIsg.png)
...
![](/static/images/blog/contents/1_ZEIqq1GRea1R2A-U6YYutQ.png)

Image courtesy of the author

This adds the page at the end with a hyperlink that takes the reader to the Amazon page when clicked on.

![](/static/images/blog/contents/1_WWwzMUwVEHhT2P8mnaY3mA.png)
...
![](/static/images/blog/contents/1_ZXbs-K5ZjY_Bovycfo5gTw.png)
...
![](/static/images/blog/contents/1_IKW2rbWEQUW0124YlyAcig.png)
...
![](/static/images/blog/contents/1_-_NpCQzBSZftokghH2rHrw.png)
...
![](/static/images/blog/contents/1_VvQkWYF8KoJEzLFKk-PhdA.png)
...
![](/static/images/blog/contents/1_qLm4q4mNa4K4921uO7l9Dw.png)

Image courtesy of the author

Once you click on the **Export** button, confirm the file location where you’d like these files to be generated.

![](/static/images/blog/contents/1_FUq23plbhetaiqpd3B7WHA.png)
...
![](/static/images/blog/contents/1_2-Citnta2rfRdRpzmyf5Eg.png)

Image courtesy of the author

Next, click on the **Create eBook** button.

![](/static/images/blog/contents/1_Tew9yhHw_g4EM7naOMTOvg.png)
...
![](/static/images/blog/contents/1_cmaqSN_RZ0976HMCCowppQ.png)
...
![](/static/images/blog/contents/1_K4XTzlVt23UwVwerhmKnKw.png)
...
![](/static/images/blog/contents/1_sdmFBbkRC7CIbLs5jppN0Q.png)
...
![](/static/images/blog/contents/1_JRskWd4ZFNqhnei9StmIUg.png)
...
![](/static/images/blog/contents/1_UO9HujeiVAjCle_7vyc7RQ.png)
...
![](/static/images/blog/contents/1_PLx__4UXaMoGVKwLbUQoEw.png)
...
![](/static/images/blog/contents/1_kOT8e2e6UwJZINX1uCG2-A.png)
...
![](/static/images/blog/contents/1_Oa7DBLCjHteSav2JOy5Awg.png)
...
![](/static/images/blog/contents/1_Si3AJ1DUHhFbdiWcAsz4DA.png)
...
![](/static/images/blog/contents/1_dbHScIiO9UgCszTZlbpHsg.png)
...
![](/static/images/blog/contents/1_hCGO5MKhycuxClyGcwQs2A.png)
...
![](/static/images/blog/contents/1_QVwuS4eeObOmqTfF3uTXRg.png)
...
![](/static/images/blog/contents/1_u8t1GFptgafLB1ou1NcRSg.png)
...
![](/static/images/blog/contents/1_Gg4fCBtHWcDDvd9Uxx2u6w.png)
...
![](/static/images/blog/contents/1_tuh0OELwZoWgla6Bo537vw.png)
...
![](/static/images/blog/contents/1_Ei-i94NpmV5ULKX1Cnf3dw.png)
