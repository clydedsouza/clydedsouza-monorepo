...
readingList: []
draft: false
images: ['/static/posts/outsystems.png']
---

<InlineImage
  src="/static/posts/outsystems.png"
...
Let's say product X costs &dollar;3.99 for 295g and product Y costs &dollar;8.99 for 591g, do you know which one is actually cheaper? Now, if I tell you that 100g of product X costs &dollar;1.35 and 100g of product Y costs &dollar;1.52, wouldn't that make it much easier to decide which one is cheaper?
...
![GIF showing OutSystems IDE taken from www.outsystems.com](/static/posts/1_nInnjfNVdUx0lbfA84K3iQ.gif)
...
![Image showing the OutSystems account creation process.](/static/posts/1_rc0VllRl8__4jFgyu2BQxA.png)
...
![GIF showing the New Application screens presented to the user in OutSystems.](/static/posts/1_dG4fA4HO_hOLvmx1JTIF4A.gif)
...
![GIF showing how you would create a new module in OutSystems.](/static/posts/1_1Ez58PDGaRq2Hlv8_Ebiww.gif)
...
![GIF showing how to create a screen in OutSystems.](/static/posts/1_KXYXYsFb7U5_Xul0z9wdDQ.gif)
...
![GIF showing how to add UI elements to the screen in OutSystems.](/static/posts/1_MC02GzGfJ-VN-g_GfP-VdA.gif)
...
![Image showing the link between text fields and variables in OutSystems.](/static/posts/1_UTASEjQ3AH3nLdfCtLyeSw.png)
...
![GIF showing how to resolve errors in OutSystems.](/static/posts/1_d67w1pAxYLkxO8fN-0bINQ.gif)
...
![GIF showing the new client action process in OutSystems.](/static/posts/1_MuDQUe4Jry0VUInOcM5-6A.gif)
...
![GIF showing the use of a formula in a client action in OutSystems.](/static/posts/1_TxP_WMHIH-yoyxQZIOslrQ.gif)
...
![GIF showing the 1-click publish process in OutSystems.](/static/posts/1_YfmRdZ9ArenNyFiz72Ip4g.gif)
...
![Image of the login screen when you first publish your app using OutSystems.](/static/posts/1_yifS2T_Anu8NAiwhfMT-vw.png)
...
![Image showing how to make your app anonymous in OutSystems.](/static/posts/1_34y9qJ97EjTayWkVhr47yQ.png)
...
![GIF showing the demo app built using OutSystems in action.](/static/posts/1_O9eQ4kS8efWfxUTPSdxtRQ.gif)
...
![GIF showing how to export the OutSystems app to native Android.](/static/posts/1_P_MYZqHkvSgqA9MlKElngQ.gif)

I've downloaded the `.apk` file and have installed it on my mobile. Here's a quick video of how it works.

![GIF showing the app in action on a mobile phone. App built using OutSystems.](/static/posts/1_bVYHNTwJIK0Ifd6Z6zjO8w.gif)
...
![GIF showing what happens when you use precision point values as inputs to the demo app.](/static/posts/1_7vYlKnSHFnLldfHd_50stg.gif)
...
![GIF showing how to fix the precision point error in OutSystems.](/static/posts/1_a59-kPZyjAfv5wmTXFg56g.gif)

`FormatCurrency` is a built-in function offered by OutSystems. It builds a text output from the parameters provided. In this example, it will prefix the output text that it gets from the **Total** variable with a “&dollar;” symbol. It displays a decimal point using a period (.) and thousands, if any, will be separated by a comma (,). The third parameter (in this case: 2) specifies the number of decimal digit after the decimal point. The output of `FormatCurrency` is concatenated with a “ /100g” to give the final result. More such functions can be found on their [technical documentation page](https://success.outsystems.com/Documentation/11/Reference/OutSystems_Language/Logic/Built-in_Functions/Format#FormatCurrency).

After republishing the app, we now have our desired result.

![GIF showing what the app looks like after handling precision points in inputs.](/static/posts/1_INUHb2ua6tS77ifdlmxwqA.gif)
...
10. Bonus section: here we looked at how you would format the output value to add a prefix of “&dollar;” and handle floating point precision.
