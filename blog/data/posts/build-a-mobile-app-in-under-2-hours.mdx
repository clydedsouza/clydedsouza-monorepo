...
![GIF showing OutSystems IDE taken from www.outsystems.com](/static/images/blog/contents/1_nInnjfNVdUx0lbfA84K3iQ.gif)
...
![Image showing the OutSystems account creation process.](/static/images/blog/contents/1_rc0VllRl8__4jFgyu2BQxA.png)
...
![GIF showing the New Application screens presented to the user in OutSystems.](/static/images/blog/contents/1_dG4fA4HO_hOLvmx1JTIF4A.gif)
...
![GIF showing how you would create a new module in OutSystems.](/static/images/blog/contents/1_1Ez58PDGaRq2Hlv8_Ebiww.gif)
...
![GIF showing how to create a screen in OutSystems.](/static/images/blog/contents/1_KXYXYsFb7U5_Xul0z9wdDQ.gif)
...
![GIF showing how to add UI elements to the screen in OutSystems.](/static/images/blog/contents/1_MC02GzGfJ-VN-g_GfP-VdA.gif)
...
![Image showing the link between text fields and variables in OutSystems.](/static/images/blog/contents/1_UTASEjQ3AH3nLdfCtLyeSw.png)
...
![GIF showing how to resolve errors in OutSystems.](/static/images/blog/contents/1_d67w1pAxYLkxO8fN-0bINQ.gif)
...
![GIF showing the new client action process in OutSystems.](/static/images/blog/contents/1_MuDQUe4Jry0VUInOcM5-6A.gif)
...
![GIF showing the use of a formula in a client action in OutSystems.](/static/images/blog/contents/1_TxP_WMHIH-yoyxQZIOslrQ.gif)
...
![GIF showing the 1-click publish process in OutSystems.](/static/images/blog/contents/1_YfmRdZ9ArenNyFiz72Ip4g.gif)
...
![Image of the login screen when you first publish your app using OutSystems.](/static/images/blog/contents/1_yifS2T_Anu8NAiwhfMT-vw.png)
...
![Image showing how to make your app anonymous in OutSystems.](/static/images/blog/contents/1_34y9qJ97EjTayWkVhr47yQ.png)
...
![GIF showing the demo app built using OutSystems in action.](/static/images/blog/contents/1_O9eQ4kS8efWfxUTPSdxtRQ.gif)
...
![GIF showing how to export the OutSystems app to native Android.](/static/images/blog/contents/1_P_MYZqHkvSgqA9MlKElngQ.gif)

I’ve downloaded the `.apk` file and have installed it on my mobile. Here’s a quick video of how it works.

![GIF showing the app in action on a mobile phone. App built using OutSystems.](/static/images/blog/contents/1_bVYHNTwJIK0Ifd6Z6zjO8w.gif)
...
![GIF showing what happens when you use precision point values as inputs to the demo app.](/static/images/blog/contents/1_7vYlKnSHFnLldfHd_50stg.gif)
...
![GIF showing how to fix the precision point error in OutSystems.](/static/images/blog/contents/1_a59-kPZyjAfv5wmTXFg56g.gif)
...
![GIF showing what the app looks like after handling precision points in inputs.](/static/images/blog/contents/1_INUHb2ua6tS77ifdlmxwqA.gif)
