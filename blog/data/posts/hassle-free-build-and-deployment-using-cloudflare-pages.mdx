...
date: '2021-03-08'
lastmod: '2021-03-08'
tags: ['Cloudflare', 'Cloudflare Pages']
readingList: ['Cloudflare']
draft: false
summary: 'Deploy your website on the edge of the internet'
images: ['/static/images/blog/cloudflareagain.png']
---

<InlineImage
  src="/static/images/blog/cloudflareagain.png"
  alt="Cloudflare Logo"
  caption={
    <>
...
![Screenshot of the Cloudflare Pages website.](https://cdn-images-1.medium.com/max/800/1*v-RgQYtI3D6Ct8Xt6iqyIg.png)
...
![Screenshot of the Cloudflare dashboard and an arrow pointing towards Cloudflare Pages option.](https://cdn-images-1.medium.com/max/800/1*mjCPQBaPpRYjOQRL4njKHg.png)
...
![An arrow pointing to the Create a project button in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*Ws6a7o4ql6sXjI1HXowUCg.png)

Let’s now connect our GitHub repository with this project. Click on the **Connect GitHub account** button.

![An arrow pointing to the Connect Github account button in the Cloudflare Pages portal.](https://cdn-images-1.medium.com/max/800/1*qp0rHoiidlz-eLt2IQIy2A.png)
...
![An image showing how to install and authorize Cloudflare Pages with GitHub.](https://cdn-images-1.medium.com/max/800/1*Ajn_UWa6N7AHL3YNa9iuBw.png)
...
![An image showing what to click when creating a new project in Cloudflare Pages and connecting with GitHub.](https://cdn-images-1.medium.com/max/800/1*cpuiRQL-jRoiiQ-0aNG9cw.png)
...
![An images showing the project configuration in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*BTSluBDTBPRvA0H_bb12Bg.png)
...
![An image of the build settings in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*9KMY5ca6BGr5RlvPmLayHg.png)
...
![An image showing how to add environment variables in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*26-AdDaddOz5Zok-XbF7YQ.png)
...
![An image show the deployment details in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*n_pJAFJbSY8P6Gml9C-wVQ.png)

Once the deployment is completed, you’ll get a URL that’s unique to that specific deployment.

![An showing the deployment details in Cloudflare Pages after a succesfull deployment.](https://cdn-images-1.medium.com/max/800/1*FuojzCXK8IelA4XbQSQE0w.png)

If you click on that link, you’ll see the React app deployed and live on the internet!

![A screenshot of the React app.](https://cdn-images-1.medium.com/max/800/1*AqX3b0IrdBLhKpoAZEbbDw.png)
...
![An showing the Cloudflare Pages build and deploy notification in GitHub.](https://cdn-images-1.medium.com/max/800/1*U8xPeHNX7FT3fCoxhQYG_w.png)
...
![An showing the Cloudflare Pages build and deploy notification in GitHub.](https://cdn-images-1.medium.com/max/800/1*ZO08AF2k6vKgv_szrW7OXA.png)
...
![A screenshot of the demo React app.](https://cdn-images-1.medium.com/max/800/1*D4LsiiyKWZkZeBUpuDYT9w.png)
...
![An image showing a list of deployments in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*rWtBSR-oPOjdiB52VhiF2A.png)
...
![An image showing the creation of a new branch in GitHub using the GitHub Desktop app.](https://cdn-images-1.medium.com/max/800/1*Tt3mDlDm0mbykVriBMyK9w.png)
...
![An image showing a list of all deployments in Cloudflare Pages.](https://cdn-images-1.medium.com/max/800/1*j31MK9hkoYD-Z7ynnKkC5A.png)
...
![An image showing the pull request details in GitHub.](https://cdn-images-1.medium.com/max/800/1*g_RGE8TnZe4xiMUQFPI1QA.png)
...
![An image showing the Cloudflare Pages comment in the pull request.](https://cdn-images-1.medium.com/max/800/1*cWiZe2vf3oMrTuUNaDOwSQ.png)
...
![An image showing the Cloudflare Pages comment in the pull request.](https://cdn-images-1.medium.com/max/800/1*JvBwbXmUp8XAjPqA2sCM8w.png)
...
![A screenshot of the code changes made to add an environment variable.](https://cdn-images-1.medium.com/max/800/1*3OVaL6yuJ3bpOgEQ5TNR9w.png)
...
![A screenshot from Cloudflare Pages showing where to add environment variables.](https://cdn-images-1.medium.com/max/800/1*Us-k35aK77xuTOqpQlo_1A.png)
...
![A screenshot of the React app in two different environments.](https://cdn-images-1.medium.com/max/800/1*8hlGVX45IqVSqrv4p6e8JA.png)
