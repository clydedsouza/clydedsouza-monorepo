...
![Screenshot of the Cloudflare Pages website.](/static/images/blog/contents/1_v-RgQYtI3D6Ct8Xt6iqyIg.png)
...
![Screenshot of the Cloudflare dashboard and an arrow pointing towards Cloudflare Pages option.](/static/images/blog/contents/1_mjCPQBaPpRYjOQRL4njKHg.png)
...
![An arrow pointing to the Create a project button in Cloudflare Pages.](/static/images/blog/contents/1_Ws6a7o4ql6sXjI1HXowUCg.png)

Let’s now connect our GitHub repository with this project. Click on the **Connect GitHub account** button.

![An arrow pointing to the Connect Github account button in the Cloudflare Pages portal.](/static/images/blog/contents/1_qp0rHoiidlz-eLt2IQIy2A.png)
...
![An image showing how to install and authorize Cloudflare Pages with GitHub.](/static/images/blog/contents/1_Ajn_UWa6N7AHL3YNa9iuBw.png)
...
![An image showing what to click when creating a new project in Cloudflare Pages and connecting with GitHub.](/static/images/blog/contents/1_cpuiRQL-jRoiiQ-0aNG9cw.png)
...
![An images showing the project configuration in Cloudflare Pages.](/static/images/blog/contents/1_BTSluBDTBPRvA0H_bb12Bg.png)
...
![An image of the build settings in Cloudflare Pages.](/static/images/blog/contents/1_9KMY5ca6BGr5RlvPmLayHg.png)
...
![An image showing how to add environment variables in Cloudflare Pages.](/static/images/blog/contents/1_26-AdDaddOz5Zok-XbF7YQ.png)
...
![An image show the deployment details in Cloudflare Pages.](/static/images/blog/contents/1_n_pJAFJbSY8P6Gml9C-wVQ.png)

Once the deployment is completed, you’ll get a URL that’s unique to that specific deployment.

![An showing the deployment details in Cloudflare Pages after a succesfull deployment.](/static/images/blog/contents/1_FuojzCXK8IelA4XbQSQE0w.png)

If you click on that link, you’ll see the React app deployed and live on the internet!

![A screenshot of the React app.](/static/images/blog/contents/1_AqX3b0IrdBLhKpoAZEbbDw.png)
...
![An showing the Cloudflare Pages build and deploy notification in GitHub.](/static/images/blog/contents/1_U8xPeHNX7FT3fCoxhQYG_w.png)
...
![An showing the Cloudflare Pages build and deploy notification in GitHub.](/static/images/blog/contents/1_ZO08AF2k6vKgv_szrW7OXA.png)
...
![A screenshot of the demo React app.](/static/images/blog/contents/1_D4LsiiyKWZkZeBUpuDYT9w.png)
...
![An image showing a list of deployments in Cloudflare Pages.](/static/images/blog/contents/1_rWtBSR-oPOjdiB52VhiF2A.png)
...
![An image showing the creation of a new branch in GitHub using the GitHub Desktop app.](/static/images/blog/contents/1_Tt3mDlDm0mbykVriBMyK9w.png)
...
![An image showing a list of all deployments in Cloudflare Pages.](/static/images/blog/contents/1_j31MK9hkoYD-Z7ynnKkC5A.png)
...
![An image showing the pull request details in GitHub.](/static/images/blog/contents/1_g_RGE8TnZe4xiMUQFPI1QA.png)
...
![An image showing the Cloudflare Pages comment in the pull request.](/static/images/blog/contents/1_cWiZe2vf3oMrTuUNaDOwSQ.png)
...
![An image showing the Cloudflare Pages comment in the pull request.](/static/images/blog/contents/1_JvBwbXmUp8XAjPqA2sCM8w.png)
...
![A screenshot of the code changes made to add an environment variable.](/static/images/blog/contents/1_3OVaL6yuJ3bpOgEQ5TNR9w.png)
...
![A screenshot from Cloudflare Pages showing where to add environment variables.](/static/images/blog/contents/1_Us-k35aK77xuTOqpQlo_1A.png)
...
![A screenshot of the React app in two different environments.](/static/images/blog/contents/1_8hlGVX45IqVSqrv4p6e8JA.png)
