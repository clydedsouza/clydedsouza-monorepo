...
draft: false
images:
  - /static/posts/lownocontentkdp.png
---

<InlineImage
  src="/static/posts/lownocontentkdp.png"
...
<CustomAd isRandom={false} adKey="MAMABOOKKINDLE" />
...
Therefore, if the list price you entered is &dollar;12 and the printing cost that Amazon estimates is &dollar;3, then you would earn a royalty of &dollar;4.20 on every single sale.
