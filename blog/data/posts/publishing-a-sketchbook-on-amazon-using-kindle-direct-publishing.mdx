...
![GIF of examples of books published by Clyde D’Souza on Amazon.](https://cdn-images-1.medium.com/max/800/1*a670g3-JI9N4mIsMaQqAmA.gif)
...
![Home page, i.e. Bookshelf, of Kindle Direct Publishing (KDP).](https://cdn-images-1.medium.com/max/800/1*w_x7O7BoaagvBKfopVc1bA.png)
...
![3-step process to publishing a paperback book on Amazon using KDP.](https://cdn-images-1.medium.com/max/800/1*5reY1K6zMUkYN4JeodeyQg.png)
...
![Image showing the format of title and subtitle on a book page.](https://cdn-images-1.medium.com/max/800/1*PrQjTC61dovkJo9H6KoWhw.png)
...
![Image showing how to get a free ISBN assigned by KDP.](https://cdn-images-1.medium.com/max/800/1*kS-QtN67Vbc1QpW3-FBJYw.png)
...
![Image showing how to generate a barcode for your ISBN for free.](https://cdn-images-1.medium.com/max/800/1*VP3CzJ1AroubELlCPDyI9Q.png)
...
![Image showing print options in KDP.](https://cdn-images-1.medium.com/max/800/1*1bdkYoOFBlPNtKkopW250w.png)
...
![Image showing the different manuscript formats available via KDP.](https://cdn-images-1.medium.com/max/800/1*ed6YLK95tF6DKyj2wJRu7A.png)
...
![Image showing a sample Word margin setting.](https://cdn-images-1.medium.com/max/800/1*6Hb_x4eIOKPVFZpuS2WXcg.png)
...
![Image annotating the interiors of your manuscript.](https://cdn-images-1.medium.com/max/800/1*ZXe4uLzYptGd8lrGOkaVKg.png)
...
![Image showing the options to select before downloading the book cover template.](https://cdn-images-1.medium.com/max/800/1*hUr7BLi9OBLVUUpJJZ5LvQ.png)
...
![Image showing where to find the PDF dimensions in Adobe Acrobat Reader.](https://cdn-images-1.medium.com/max/800/1*kpS_sGPOpvV-ZCwBSjmFlA.png)
...
![Step 1: Adding barcode and spine guidelines over the template](https://cdn-images-1.medium.com/max/800/1*ZI13rPx8OQMkSy_xlgBDpA.png)
...
![Step 2: In a new page, copy the spine guideline element across.](https://cdn-images-1.medium.com/max/800/1*kAQxGcJdWpTz7DB-Nly7qg.png)
...
![Step 3: Design your cover, then add the barcode guideline element.](https://cdn-images-1.medium.com/max/800/1*WGkkqgP5EZKjNWmiN5oe3A.png)
...
![Image showing the barcode area in the book cover.](https://cdn-images-1.medium.com/max/800/1*u9eWnrvjigstlH1RAIBUtA.png)
...
![PDF download options in Canva.](https://cdn-images-1.medium.com/max/800/1*G5hUzzdh0SdCfcohQpWyyg.png)

This is what my final downloaded PDF looks like.

![Final preview of the finished book cover.](https://cdn-images-1.medium.com/max/800/1*4k8jkPM4VQ4Nlw60T2rrWA.png)
...
![Image showing how to upload the book cover in Amazon KDP.](https://cdn-images-1.medium.com/max/800/1*aL2S0eQnlg36sClnItH7jw.png)
...
![Image showing how to approve the print preview in KDP.](https://cdn-images-1.medium.com/max/800/1*IbPf5I0nMe_qXCHp0m14Bg.png)
...
![Image showing the various marketplaces available for paperback books in KDP.](https://cdn-images-1.medium.com/max/800/1*9AeO4G9-07Svs4kUMceSgw.png)
