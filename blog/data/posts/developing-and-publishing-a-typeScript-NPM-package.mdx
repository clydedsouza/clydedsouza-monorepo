...
![Image of source code directory.](/static/images/blog/contents/1_glIaPPkmBzmXlKWHs8AM1g.png)
...
![Image of the dist folder with compiled files in it.](/static/images/blog/contents/1_P9sHtBNJvkfKk7gKlO8gQA.png)
...
![Image of all unit tests passing.](/static/images/blog/contents/1_3TuIbTnJsFF716Il2HhCLw.png)
...
![Image of test coverage summary report.](/static/images/blog/contents/1_5oirZp9M6kxHb85XNwh60g.png)
...
![Image of a function highlighting the whitespace to remove so ESLint can be tested.](/static/images/blog/contents/1_FCba-GGzGlthx3S0TUPE0w.png)
...
![Screenshot of SonarCloud’s home page.](/static/images/blog/contents/1_RaHozMw9-nlB0qbY4KRWdg.png)
...
![Screenshot of SonarCloud projects home page and arrows pointing the buttons to click.](/static/images/blog/contents/1_Z8p_nSdIRhWi64BQcn6_Yw.png)

Search for your repository, check the box beside it, and then click on the **Set Up**.

![Image showing the steps to add a GitHub repository to SonarCloud.](/static/images/blog/contents/1_PuKpNRcfqW5RP-AvsYgVHw.png)

SonarCloud will start analyzing your project and show you the first analysis report.

![Screenshot of SonarCloud analyzing the source code for the first time.](/static/images/blog/contents/1_6wNMM2eCYpPnDxsCcM5M3w.png)
...
![Image showing the steps to set new code definition in SonarCloud.](/static/images/blog/contents/1_BZjOwI4RtXBGy2wzYN4mrg.png)
...
![Screenshot of a SonarCloud quality gate comment in a GitHub pull request.](/static/images/blog/contents/1_yJqWMM25PzycSqv0_KxjOg.png)
...
![Screenshot of SonarCloud’s overview tab.](/static/images/blog/contents/1_6dBuZKsb0a4F7yLAg6nB-g.png)
...
![Screenshot showing npm adduser command in action.](/static/images/blog/contents/1_OLbRAq7afwNuPwB-C7u0ww.png)

#### Getting help

At any given time, should you require help with any of the commands, just type the command followed by `-help`.

![Screenshot showing how to get help for a command in npm.](/static/images/blog/contents/1_WzlVuSE84a7k_We_c9gJhA.png)
...
![Screenshot showing npm dry-run command in action.](/static/images/blog/contents/1_Ctcy9EteMNQbJIkjhctTVw.png)
...
![Screenshot showing npm publish command in action.](/static/images/blog/contents/1_bQB1HxaE0XmyBOgY8cQY7g.png)
...
![Screenshot of the demo npm package’s public page.](/static/images/blog/contents/1_Jih4daKTE6z2iTHd1OLVpA.png)
