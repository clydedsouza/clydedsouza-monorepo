...
readingList: []
draft: false
summary: 'We’ll also cover unit testing, test coverage and code analysis'
images: ['/static/images/blog/makenpm.png']
---

<InlineImage
  src="/static/images/blog/makenpm.png"
...
![Image of source code directory.](https://cdn-images-1.medium.com/max/800/1*glIaPPkmBzmXlKWHs8AM1g.png)
...
![Image of the dist folder with compiled files in it.](https://cdn-images-1.medium.com/max/800/1*P9sHtBNJvkfKk7gKlO8gQA.png)
...
![Image of all unit tests passing.](https://cdn-images-1.medium.com/max/800/1*3TuIbTnJsFF716Il2HhCLw.png)
...
![Image of test coverage summary report.](https://cdn-images-1.medium.com/max/800/1*5oirZp9M6kxHb85XNwh60g.png)
...
![Image of a function highlighting the whitespace to remove so ESLint can be tested.](https://cdn-images-1.medium.com/max/800/1*FCba-GGzGlthx3S0TUPE0w.png)
...
![Screenshot of SonarCloud’s home page.](https://cdn-images-1.medium.com/max/800/1*RaHozMw9-nlB0qbY4KRWdg.png)
...
![Screenshot of SonarCloud projects home page and arrows pointing the buttons to click.](https://cdn-images-1.medium.com/max/1200/1*Z8p_nSdIRhWi64BQcn6_Yw.png)

Search for your repository, check the box beside it, and then click on the **Set Up**.

![Image showing the steps to add a GitHub repository to SonarCloud.](https://cdn-images-1.medium.com/max/800/1*PuKpNRcfqW5RP-AvsYgVHw.png)

SonarCloud will start analyzing your project and show you the first analysis report.

![Screenshot of SonarCloud analyzing the source code for the first time.](https://cdn-images-1.medium.com/max/800/1*6wNMM2eCYpPnDxsCcM5M3w.png)
...
![Image showing the steps to set new code definition in SonarCloud.](https://cdn-images-1.medium.com/max/800/1*BZjOwI4RtXBGy2wzYN4mrg.png)
...
![Screenshot of a SonarCloud quality gate comment in a GitHub pull request.](https://cdn-images-1.medium.com/max/800/1*yJqWMM25PzycSqv0_KxjOg.png)
...
![Screenshot of SonarCloud’s overview tab.](https://cdn-images-1.medium.com/max/800/1*6dBuZKsb0a4F7yLAg6nB-g.png)
...
![Screenshot showing npm adduser command in action.](https://cdn-images-1.medium.com/max/800/1*OLbRAq7afwNuPwB-C7u0ww.png)

#### Getting help

At any given time, should you require help with any of the commands, just type the command followed by `-help`.

![Screenshot showing how to get help for a command in npm.](https://cdn-images-1.medium.com/max/800/1*WzlVuSE84a7k_We_c9gJhA.png)
...
![Screenshot showing npm dry-run command in action.](https://cdn-images-1.medium.com/max/800/1*Ctcy9EteMNQbJIkjhctTVw.png)
...
![Screenshot showing npm publish command in action.](https://cdn-images-1.medium.com/max/800/1*bQB1HxaE0XmyBOgY8cQY7g.png)
...
![Screenshot of the demo npm package’s public page.](https://cdn-images-1.medium.com/max/800/1*Jih4daKTE6z2iTHd1OLVpA.png)
