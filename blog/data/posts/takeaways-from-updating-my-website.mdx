...
readingList: []
draft: false
summary: 'Includes generating an API from Markdown files and a lot more'
images: ['/static/images/blog/updatewebsite.png']
---

<InlineImage
  src="/static/images/blog/updatewebsite.png"
...
![High-level architecture diagram of the website www.clydedsouza.net](https://cdn-images-1.medium.com/max/1200/1*Gn9Yk2_wltrGFhWphDdSeQ.jpeg)
...
![Image showing the difference between old and new website navigation.](https://cdn-images-1.medium.com/max/800/1*ro7N61plBlqnsWIIXf5jAg.gif)
...
![GIF showing the comparision for the highlights section in the old website versus the new website.](https://cdn-images-1.medium.com/max/800/1*wM43xkQpPhOko1xwZILszg.gif)
...
![GIF showing the call to action section in desktop and mobile devices.](https://cdn-images-1.medium.com/max/800/1*ytaeG3dQ25M3bAOV-l7ypQ.gif)
...
![Image show the difference between two real-time messaging icons in the website.](https://cdn-images-1.medium.com/max/800/1*CiM3u-jbaMcxd1yPgYw8cw.gif)
...
![GIF showing the new website design versus the old website design](https://cdn-images-1.medium.com/max/1200/1*bdwZm7B-Z9bSIW6av4oYdA.gif)
...
![High-level diagram outlining the process of adding a portfolio item to consuming that data via the API](https://cdn-images-1.medium.com/max/1200/1*RudtGed0a6byblO9MVm6VA.jpeg)
...
![Image showing what editing project content in Forestry looks like.](https://cdn-images-1.medium.com/max/800/1*CnztzRkGsOouflW3f1NFZQ.png)
...
![High-level diagram outlining the process of adding an image/CSS/JavaScript file to consuming that file.](https://cdn-images-1.medium.com/max/1200/1*RBLl-mgMVqtckbQCWwxzkA.jpeg)
