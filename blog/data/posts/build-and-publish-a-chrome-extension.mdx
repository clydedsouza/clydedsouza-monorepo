---
title: 'Build and Publish a Chrome Extension'
subtitle: 'Share your work with millions of users'
date: '2022-10-23'
lastmod: '2022-10-23'
tags: ['Chrome Extension', 'Chrome', 'Programming', 'Google Chrome Extensions', 'Web Development']
readingList: ['Chrome Extensions']
draft: false
images: ['/static/posts/chromepsy.png']
---

<InlineImage
  src="/static/posts/chromepsy.png"
  alt="Google Chrome logo over an image from Unsplash."
  caption={
    <>
      Image source: Google Chrome logo over a background from{' '}
      <a href="https://unsplash.com/photos/8Qpqs04ATRk">Unsplash</a>
    </>
  }
/>
...
![Chrome and Chrome extension high-level architecture.](/static/posts/1_2eaGkVfRT2GfjhnRV8GyaA.jpeg)
...
![Different features of a Chrome extension.](/static/posts/1_qRbHph364cgWK2DLh15hJQ.jpeg)
...
{
  "manifest_version": 3,
  "name": "Simple Chrome Extension Template",
...
Let's update our manifest file and register this feature. We'll add the following snippet to the manifest file. This assigns the `newtab.html` file as Chrome's new tab. Also, you don't have to name this file _newtab_. It could be named anything you like.
...
![Loading a Chrome extension locally for development-testing.](/static/posts/1_479pUrPcvRB3kt-l2nC9nA.png)

Now, if you click on the new tab, you should see your HTML page. Ta-da!

#### Publishing your extension

Using a Google account, you will want to [register as a Chrome Web Store developer](https://chrome.google.com/webstore/devconsole/). You'll be asked to accept the developer agreement and also pay a one-time registration fee of &dollar;5.
...
![Chrome Web Store Developer Dashboard store listing page.](/static/posts/1_CjWaCIjS0uhgogVIWC_4bw.png)
...
![Chrome Web Store Developer Dashboard privacy practices page.](/static/posts/1_v55J4dNZzZXKZWEc0OkcsQ.png)
...
![Source folder and distribution folder separated by a webpack process.](/static/posts/1_QZq7Nz9Zy_3lUiQsDAEq7g.jpeg)
