...
draft: false
summary: 'Share your work with millions of users'
images: ['/static/images/blog/chromepsy.png']
---

<InlineImage
  src="/static/images/blog/chromepsy.png"
...
![Chrome and Chrome extension high-level architecture.](/static/images/blog/contents/1_2eaGkVfRT2GfjhnRV8GyaA.jpeg)
...
![Different features of a Chrome extension.](/static/images/blog/contents/1_qRbHph364cgWK2DLh15hJQ.jpeg)
...
Let’s update our manifest file and register this feature. We’ll add the following snippet to the manifest file. This assigns the `newtab.html` file as Chrome’s new tab. Also, you don’t have to name this file _newtab.&#x20;_&#x49;t could be named anything you like.
...
![Loading a Chrome extension locally for development-testing.](/static/images/blog/contents/1_479pUrPcvRB3kt-l2nC9nA.png)
...
![Chrome Web Store Developer Dashboard store listing page.](/static/images/blog/contents/1_CjWaCIjS0uhgogVIWC_4bw.png)
...
![Chrome Web Store Developer Dashboard privacy practices page.](/static/images/blog/contents/1_v55J4dNZzZXKZWEc0OkcsQ.png)
...
![Source folder and distribution folder separated by a webpack process.](/static/images/blog/contents/1_QZq7Nz9Zy_3lUiQsDAEq7g.jpeg)
