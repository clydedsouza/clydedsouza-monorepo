...
date: '2021-04-06'
lastmod: '2021-04-06'
tags: ['React', 'GitHub', 'GitHub Pages', 'GitHub Actions', 'Typescript', 'Create React App']
readingList: ['GitHub Actions']
draft: false
images: ['/static/posts/ghapages.png']
---

<InlineImage
  src="/static/posts/ghapages.png"
...
![Screenshot of the project directory after completing step 1 of this article.](/static/posts/1_c6AsfWCMC-5uANCLBZXqDg.png)
...
![Screenshot of GitHub Actions UI featuring a successful workflow run.](/static/posts/1_kHWQ5K54ZtRuHveK6LHPZQ.png)
...
![Screenshot of the gh-pages branch of the GitHub repository.](/static/posts/1_mVszntQwIxruxEc8f1WO4Q.png)
...
![Screenshot showing how to enable GitHub Pages.](/static/posts/1_bb8oLbOoLvTSy9vWS9dGVQ.png)

Wait, what happened? I can't see the React app output, can you?

![Screenshot showing the demo website with an empty screen and error messages in the console.](/static/posts/1_pdrhN-O9vYXHK4heNYxgHQ.png)
...
![Screenshot showing the demo website.](/static/posts/1_BIgZyEBdo6AndYQ17APTew.png)
...
![GIF showing the observed error after adding navigation.](/static/posts/1_yFdoJ72WUHHi02HmKOcROQ.gif)
