...
date: '2021-04-22'
lastmod: '2021-04-22'
tags: ['eBook', 'Kindle Create']
readingList: ['Publishing a book']
draft: false
summary: 'Demystifying the process of making your eBook readable on various device types'
images: ['/static/images/blog/kindlecreate.png']
---

<InlineImage
  src="/static/images/blog/kindlecreate.png"
...
![Screenshot of the first page of a manuscript.](https://cdn-images-1.medium.com/max/800/1*WE8eRdTvoWXkrOUenA3HXQ.png)
...
![Screenshot of the available styles in Microsoft Word.](https://cdn-images-1.medium.com/max/800/1*7RCajvVxpU5o60KEkw-Yzg.png)
...
![GIF showing how to add a page break in Microsoft Word.](https://cdn-images-1.medium.com/max/1200/1*4hXaW4vccucyeSkAg7Sg1g.gif)
...
![Screenshot of a sample copyright text block.](https://cdn-images-1.medium.com/max/800/1*mIzSHwwbv9VY2p8oi4hHaw.png)
...
![GIF showing how to modify an existing style in Microsoft Word.](https://cdn-images-1.medium.com/max/800/1*8PrRw64PpnGbAO9VDPoPLw.gif)
...
![Screenshot showing what to modify to format the manuscript body.](https://cdn-images-1.medium.com/max/800/1*WDBmJQZ4fvKf0nL9IV9ySA.png)
...
![Screenshot showing how to add a table of contents in Microsoft Word.](https://cdn-images-1.medium.com/max/800/1*hzuba9GE6i2fgJHJqs85Mw.png)
...
![Screenshot showing the configuration used for the table of contents in Microsoft Word.](https://cdn-images-1.medium.com/max/800/1*9kUX4vqgpCUR7KnFgnjk-g.png)
...
![Screenshot showing how to update the table of contents.](https://cdn-images-1.medium.com/max/800/1*uOIbbQnlwsjDfJcNAbYMTQ.png)

Image courtesy of the author

If you don’t want ‘Content&#x73;_’_ itself to appear in the table of contents, select that block of text and hit the delete button so that your first chapter is the first item in the table of contents.
...
![Screenshot of the Kindle Create logo in the Windows start menu.](https://cdn-images-1.medium.com/max/800/1*NKIj5Xd0-JOB0iEgO6VmmA.png)
...
![Screenshot of the first step when creating a new project in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*_MKKjD5iHkbyUXOeJlS8tQ.png)
...
![Screenshot of the second step when creating a new project in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*VSM1Ka0oELrealNWgUJ_4g.png)

Image courtesy of the author

Depending on the size of the Word document, it may take a few moments for the import process to complete.

![Screenshot of the import in progress window seen after importing a Word document in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*e_iPAFu46nMMMk3eh0MUkQ.png)

Image courtesy of the author

Once the Word document is successfully imported, click on **Continue** to proceed ahead.

![Screenshot of the upload successful window seen after importing a Word document in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*ZqAPdD6GIcslkz8KQnvP9A.png)
...
![Screenshot of the chapter titles automatically detected by Kindle Create after importing a Word document.](https://cdn-images-1.medium.com/max/800/1*-3yCoslZ0F2JISiDZz-7GQ.png)
...
![Step annotated screenshot of the Kindle Create software.](https://cdn-images-1.medium.com/max/1200/1*wxvEnDJnt3Klc1bH5TrUjg.png)
...
![GIF showing how to apply a style to a selected text in Kindle Create.](https://cdn-images-1.medium.com/max/1200/1*H4X8sFResv40og60W4kojA.gif)
...
![GIF showing how to apply a style to a text block in Kindle Create.](https://cdn-images-1.medium.com/max/1200/1*PXFf6Y_Mm0XKsiuDqDUA2Q.gif)
...
![Screenshot showing the clear button in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*BFW4lME_qdBRu5H9mijlDQ.png)
...
![Screenshot showing the formatting tab in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*2NJ-qsGDOU-qyuMOz_qnfw.png)
...
![Screenshot showing what the previewer looks like in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*NPClsU_3yZdyXqimuQsamw.png)
...
![Screenshot showing the two available tabs in the previewer mode in Kindle Create.](https://cdn-images-1.medium.com/max/800/1*xMHGaHX-3qFuNvzbKNKj7w.png)
...
![Screenshot of the window seen after publishing a .kpf file.](https://cdn-images-1.medium.com/max/800/1*2z-PKd0AF2F8cIJHzbd1Aw.png)
...
![Screenshot of the .kpf file icon in file explorer.](https://cdn-images-1.medium.com/max/800/1*jNk7aqI4N4rwc0BrtTl1Ow.png)
...
![Screenshot showing how to create an eBook in Kindle Direct Publishing.](https://cdn-images-1.medium.com/max/800/1*77ZCkT3oRTPcAXDSFz0-JA.png)
...
![Screenshot showing how to upload the .kpf file in Kindle Direct Publishing.](https://cdn-images-1.medium.com/max/800/1*wFCTu7VUGJ98VBNk4xqlIg.png)
...
![Screenshot of the upload in progress window when a .kpf file is uploaded to Kindle Direct Publishing.](https://cdn-images-1.medium.com/max/800/1*2c3heKXUx5qWk8dTWH5YOg.png)
...
![Screenshot of the success message seen after successfully uploading the .kpf file in Kindle Direct Publishing.](https://cdn-images-1.medium.com/max/800/1*VavPeLztDqFExv462LDP9w.png)
...
![Screenshot showing how to launch the online previewer in Kindle Direct Publishing.](https://cdn-images-1.medium.com/max/800/1*GYRJrtX2GnDKrI1BE-08LA.png)
...
![Screenshot of the online previewer in Kindle Direct Publishing.](https://cdn-images-1.medium.com/max/1200/1*QYJ7HfH5DHBZFaYS4nOUzw.png)
...
![Screenshot of the options available in the table of contents dropdown in the online previewer.](https://cdn-images-1.medium.com/max/800/1*2LhZSc2yFOcoHaS_vOy4uQ.png)
...
You don’t _have&#x20;_&#x74;o use Kindle Create although it’s recommended if you’re publishing for Kindle devices. Amazon does support a few other eBook formats as well, as outlined [here](https://kdp.amazon.com/en_US/help/topic/G200634390).
