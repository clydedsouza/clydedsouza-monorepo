...
![Screenshot of the first page of a manuscript.](/static/images/blog/contents/1_WE8eRdTvoWXkrOUenA3HXQ.png)
...
![Screenshot of the available styles in Microsoft Word.](/static/images/blog/contents/1_7RCajvVxpU5o60KEkw-Yzg.png)
...
![GIF showing how to add a page break in Microsoft Word.](/static/images/blog/contents/1_4hXaW4vccucyeSkAg7Sg1g.gif)
...
![Screenshot of a sample copyright text block.](/static/images/blog/contents/1_mIzSHwwbv9VY2p8oi4hHaw.png)
...
![GIF showing how to modify an existing style in Microsoft Word.](/static/images/blog/contents/1_8PrRw64PpnGbAO9VDPoPLw.gif)
...
![Screenshot showing what to modify to format the manuscript body.](/static/images/blog/contents/1_WDBmJQZ4fvKf0nL9IV9ySA.png)
...
![Screenshot showing how to add a table of contents in Microsoft Word.](/static/images/blog/contents/1_hzuba9GE6i2fgJHJqs85Mw.png)
...
![Screenshot showing the configuration used for the table of contents in Microsoft Word.](/static/images/blog/contents/1_9kUX4vqgpCUR7KnFgnjk-g.png)
...
![Screenshot showing how to update the table of contents.](/static/images/blog/contents/1_uOIbbQnlwsjDfJcNAbYMTQ.png)
...
![Screenshot of the Kindle Create logo in the Windows start menu.](/static/images/blog/contents/1_NKIj5Xd0-JOB0iEgO6VmmA.png)
...
![Screenshot of the first step when creating a new project in Kindle Create.](/static/images/blog/contents/1__MKKjD5iHkbyUXOeJlS8tQ.png)
...
![Screenshot of the second step when creating a new project in Kindle Create.](/static/images/blog/contents/1_VSM1Ka0oELrealNWgUJ_4g.png)

Image courtesy of the author

Depending on the size of the Word document, it may take a few moments for the import process to complete.

![Screenshot of the import in progress window seen after importing a Word document in Kindle Create.](/static/images/blog/contents/1_e_iPAFu46nMMMk3eh0MUkQ.png)

Image courtesy of the author

Once the Word document is successfully imported, click on **Continue** to proceed ahead.

![Screenshot of the upload successful window seen after importing a Word document in Kindle Create.](/static/images/blog/contents/1_ZqAPdD6GIcslkz8KQnvP9A.png)
...
![Screenshot of the chapter titles automatically detected by Kindle Create after importing a Word document.](/static/images/blog/contents/1_-3yCoslZ0F2JISiDZz-7GQ.png)
...
![Step annotated screenshot of the Kindle Create software.](/static/images/blog/contents/1_wxvEnDJnt3Klc1bH5TrUjg.png)
...
![GIF showing how to apply a style to a selected text in Kindle Create.](/static/images/blog/contents/1_H4X8sFResv40og60W4kojA.gif)
...
![GIF showing how to apply a style to a text block in Kindle Create.](/static/images/blog/contents/1_PXFf6Y_Mm0XKsiuDqDUA2Q.gif)
...
![Screenshot showing the clear button in Kindle Create.](/static/images/blog/contents/1_BFW4lME_qdBRu5H9mijlDQ.png)
...
![Screenshot showing the formatting tab in Kindle Create.](/static/images/blog/contents/1_2NJ-qsGDOU-qyuMOz_qnfw.png)
...
![Screenshot showing what the previewer looks like in Kindle Create.](/static/images/blog/contents/1_NPClsU_3yZdyXqimuQsamw.png)
...
![Screenshot showing the two available tabs in the previewer mode in Kindle Create.](/static/images/blog/contents/1_xMHGaHX-3qFuNvzbKNKj7w.png)
...
![Screenshot of the window seen after publishing a .kpf file.](/static/images/blog/contents/1_2z-PKd0AF2F8cIJHzbd1Aw.png)
...
![Screenshot of the .kpf file icon in file explorer.](/static/images/blog/contents/1_jNk7aqI4N4rwc0BrtTl1Ow.png)
...
![Screenshot showing how to create an eBook in Kindle Direct Publishing.](/static/images/blog/contents/1_77ZCkT3oRTPcAXDSFz0-JA.png)
...
![Screenshot showing how to upload the .kpf file in Kindle Direct Publishing.](/static/images/blog/contents/1_wFCTu7VUGJ98VBNk4xqlIg.png)
...
![Screenshot of the upload in progress window when a .kpf file is uploaded to Kindle Direct Publishing.](/static/images/blog/contents/1_2c3heKXUx5qWk8dTWH5YOg.png)
...
![Screenshot of the success message seen after successfully uploading the .kpf file in Kindle Direct Publishing.](/static/images/blog/contents/1_VavPeLztDqFExv462LDP9w.png)
...
![Screenshot showing how to launch the online previewer in Kindle Direct Publishing.](/static/images/blog/contents/1_GYRJrtX2GnDKrI1BE-08LA.png)
...
![Screenshot of the online previewer in Kindle Direct Publishing.](/static/images/blog/contents/1_QYJ7HfH5DHBZFaYS4nOUzw.png)
...
![Screenshot of the options available in the table of contents dropdown in the online previewer.](/static/images/blog/contents/1_2LhZSc2yFOcoHaS_vOy4uQ.png)
