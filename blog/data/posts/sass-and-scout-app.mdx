...
images: ['/static/images/blog/scout.png']
---

<InlineImage
  src="/static/images/blog/scout.png"
...
![GIF illustrating the 4 parts covered in this article](https://cdn-images-1.medium.com/max/800/1*txUEftBXiP-jJVYPn1JoNA.gif)
...
![Screenshot showing the code that references a CSS file and the output of the code beside it.](https://cdn-images-1.medium.com/max/1200/1*uHMWQbgoGb5UDBVBWcQtfQ.png)
...
![Screenshot of the SCSS file and the output of the HTML code.](https://cdn-images-1.medium.com/max/1200/1*JjuHijKl4uV0AQtDmbpchA.png)
...
![Screenshot of Scout-App’s website.](https://cdn-images-1.medium.com/max/800/1*h4UdFESde6p33-cDkVijjQ.png)
...
![Screenshot showing how to add a project into Scout-App.](https://cdn-images-1.medium.com/max/800/1*EOOjlybuGN_IVRaLF772EA.png)
...
![Screenshot showing how to configure Scout-App.](https://cdn-images-1.medium.com/max/1200/1*R6Bo3euGd2Ixn50g9ly3pg.png)

Click the play icon next to the website project folder, as pictured below. This will initiate the compiling process.

![Screenshot showing how to compile SCSS files in Scout-App.](https://cdn-images-1.medium.com/max/1200/1*AoPk4gPWq1d2kpHSS5Ypjw.png)
...
![Screenshot showing where the compiled CSS files from Scout-App can be found.](https://cdn-images-1.medium.com/max/1200/1*Y37-YYjAC1zAL79VQhvJDg.png)
...
![Screenshot of the SCSS code using variables.](https://cdn-images-1.medium.com/max/800/1*NgOwFFzpudtHrrGzUsPSyg.png)
...
![Screenshot showing steps to perform after updating a SCSS variables value.](https://cdn-images-1.medium.com/max/1200/1*GnelV8q7OfEbv1jxMSz2mw.png)
...
![Screenshot showing how to create and reference a partial SCSS file.](https://cdn-images-1.medium.com/max/1200/1*HcgNO-2ib6KP0-9EmnoxGw.png)
