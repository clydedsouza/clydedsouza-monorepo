...
![GIF illustrating the 4 parts covered in this article](/static/images/blog/contents/1_txUEftBXiP-jJVYPn1JoNA.gif)
...
![Screenshot showing the code that references a CSS file and the output of the code beside it.](/static/images/blog/contents/1_uHMWQbgoGb5UDBVBWcQtfQ.png)
...
![Screenshot of the SCSS file and the output of the HTML code.](/static/images/blog/contents/1_JjuHijKl4uV0AQtDmbpchA.png)
...
![Screenshot of Scout-App’s website.](/static/images/blog/contents/1_h4UdFESde6p33-cDkVijjQ.png)
...
![Screenshot showing how to add a project into Scout-App.](/static/images/blog/contents/1_EOOjlybuGN_IVRaLF772EA.png)
...
![Screenshot showing how to configure Scout-App.](/static/images/blog/contents/1_R6Bo3euGd2Ixn50g9ly3pg.png)

Click the play icon next to the website project folder, as pictured below. This will initiate the compiling process.

![Screenshot showing how to compile SCSS files in Scout-App.](/static/images/blog/contents/1_AoPk4gPWq1d2kpHSS5Ypjw.png)
...
![Screenshot showing where the compiled CSS files from Scout-App can be found.](/static/images/blog/contents/1_Y37-YYjAC1zAL79VQhvJDg.png)
...
![Screenshot of the SCSS code using variables.](/static/images/blog/contents/1_NgOwFFzpudtHrrGzUsPSyg.png)
...
![Screenshot showing steps to perform after updating a SCSS variables value.](/static/images/blog/contents/1_GnelV8q7OfEbv1jxMSz2mw.png)
...
![Screenshot showing how to create and reference a partial SCSS file.](/static/images/blog/contents/1_HcgNO-2ib6KP0-9EmnoxGw.png)
