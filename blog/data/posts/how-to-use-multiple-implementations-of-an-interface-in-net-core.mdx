---
title: 'How To Use Multiple Implementations of an Interface in .NET Core?'
subtitle: 'Registering and retrieving multiple implementations from the IoC container'
date: '2023-10-19'
lastmod: '2023-10-19'
tags: ['one', 'two']
readingList: []
draft: false
summary: 'Registering and retrieving multiple implementations from the IoC container'
images: ['/static/images/blog/flowers.jpg']
---

<InlineImage
  src="/static/images/blog/flowers.jpg"
  alt="Featured image of this article showing two identical looking flowers loosely representing the topic of this article."
  caption={
    <>
      Image source: <a href="https://unsplash.com/photos/EC7bv_A8JU0">Unsplash</a>
    </>
  }
/>
...
![](/static/images/blog/contents/1_a8-Vf6GYtOGAXmJcDKs7NA.png)
...
![](/static/images/blog/contents/1_oHNb6zT0apqkmmTeJ1FYhQ.png)
...
![](/static/images/blog/contents/1_TYI592ADYKX4RflPM4f6Sw.png)
...
![](/static/images/blog/contents/1_GYbDfpcAtSlxJf9yOZ3WZg.png)
...
![](/static/images/blog/contents/1_K5qYimozZtHF8JzBpxjM9Q.png)
...
![](/static/images/blog/contents/1_fCDTXvhrJnqDb_kZ4lbdWA.png)
...
![](/static/images/blog/contents/1_pPIEYHCyVl2MvRgqGjfTdw.png)
...
![](/static/images/blog/contents/1_srCkkM1fjZpdLCCd1Bfhsw.png)
...
![](/static/images/blog/contents/1_Xyv78ykoGjdL_YXn9EXsFA.png)

Image courtesy of the author

And the output in the console application is printed correctly, too!

![](/static/images/blog/contents/1_8OhQIsW5jwWKnzDJUkNC9w.png)
...
![](/static/images/blog/contents/1_uHKZm0N10P2i9_CXkND9LA.png)
