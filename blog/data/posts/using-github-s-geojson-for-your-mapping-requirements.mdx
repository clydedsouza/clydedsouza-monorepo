...
readingList: []
draft: false
summary: 'How the Ministry of Health NZ displays covid locations of interest on their website'
images: ['/static/images/blog/maps.jpg']
---

<InlineImage
  src="/static/images/blog/maps.jpg"
...
![An image of the properties tab selected on a GeoJSON rendered map.](/static/images/blog/contents/1_7NcXrEpKJlbXeatp9PfG_g.png)

Clicking on the **Info** tab from the pop up will give you the area of the selected feature, which is pretty useful.

![An image of the info tab selected on a GeoJSON rendered map.](/static/images/blog/contents/1_CXsAfNnumvIbrBTxFJwELg.png)
...
![An image of a marker on a GeoJSON rendered map.](/static/images/blog/contents/1_SaoWrfwUsmhnIdwJ_8v_YA.png)
...
![An image of a marker rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_w6ZdnnTjfS6QzbeVvwYvtg.png)
...
![An image of multiple points rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_EKhFsrUk_BzKF_teH1NteA.png)
...
![An image of a line rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_LtMKnDmWqpIjD1uc9bBV8A.png)
...
![An image of a rectangle rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_DJmxKBBKaG89KYfbaZ7Wpw.png)
...
![An image of an polygon rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_WCfesVthesBPjjgm0Z05Ag.png)
...
![An image of all objects rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_lP0a1rbXFsNQacHB_lKv7A.png)
...
![An image of Ministry of Health NZ’s locations of interest rendered on a GeoJSON rendered map.](/static/images/blog/contents/1_cpVcQ0QQOy89lmuSS_t31A.png)
