...
images: ['/static/images/blog/netlifyazuredevops.png']
---

<InlineImage
  src="/static/images/blog/netlifyazuredevops.png"
...
![Image showing how to add Netlify task into the release pipeline.](https://cdn-images-1.medium.com/max/800/1*ZyjoJDmsKgq4e7BYdlHyzg.png)
...
![Image of the Install Netlify task from the Netlify Azure DevOps extension.](https://cdn-images-1.medium.com/max/800/1*lt21VrxH4qjtDBbd61XJDA.png)
...
![Image of the Deploy Website task from the Netlify Azure DevOps extension.](https://cdn-images-1.medium.com/max/800/1*N8c9IVoRrT3TwYbWRhb24Q.png)
...
![Image showing Netlify dashboard](https://cdn-images-1.medium.com/max/800/1*3Lwe9MWcb2at4pfDdCSAtA.png)
...
![Image showing a command prompt to install the Netlify-CLI utility.](https://cdn-images-1.medium.com/max/800/1*dctoqeU9UqtpiWC9lcAohg.png)

Next, we’ll log in to our Netlify account via the CLI. Type in the command `netlify login`.

![Image showing a command prompt using the Netlify login command.](https://cdn-images-1.medium.com/max/800/1*hTlkopNl0J7f6hWsu04Bqw.png)
...
![Image showing the authorize application prompt by Netlify.](https://cdn-images-1.medium.com/max/800/1*PoBVVtGyRpQOxfsFVm36Zw.png)
...
![Image showing the command to create a new empty site in Netlify.](https://cdn-images-1.medium.com/max/800/1*B_hTgi0SstvgR8-NuNu1JA.png)
...
![Image showing how to capture the site ID from Netlify.](https://cdn-images-1.medium.com/max/800/1*QwT-I6Mrdj0LCIbBTCTbxw.png)
...
![](https://cdn-images-1.medium.com/max/800/1*nI303WVwcc8Y2pP7uEXFoQ.png)
...
![Image showing the release variables in Azure DevOps.](https://cdn-images-1.medium.com/max/800/1*QFAfHMgrtdncV9J_mBkorA.png)

#### **Give it a go!**

Now, create a new release and watch the magic happen. This is what my demo website looks like once deployed:

![Image showing the demo website.](https://cdn-images-1.medium.com/max/800/1*MzTjEnoaYM05tHFq0NfPzA.png)
...
![Image showing how to inject a snippet in Netlify.](https://cdn-images-1.medium.com/max/800/1*xKQbHWnBfHhLpjqqVAwb_w.png)
...
![Image showing a snippet to disallow search engines from crawling the website.](https://cdn-images-1.medium.com/max/800/1*L3o1lrbFuPV6YvHJU-n-zQ.png)
