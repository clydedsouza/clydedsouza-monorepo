...
![Image showing how to add Netlify task into the release pipeline.](/static/images/blog/contents/1_ZyjoJDmsKgq4e7BYdlHyzg.png)
...
![Image of the Install Netlify task from the Netlify Azure DevOps extension.](/static/images/blog/contents/1_lt21VrxH4qjtDBbd61XJDA.png)
...
![Image of the Deploy Website task from the Netlify Azure DevOps extension.](/static/images/blog/contents/1_N8c9IVoRrT3TwYbWRhb24Q.png)
...
![Image showing Netlify dashboard](/static/images/blog/contents/1_3Lwe9MWcb2at4pfDdCSAtA.png)
...
![Image showing a command prompt to install the Netlify-CLI utility.](/static/images/blog/contents/1_dctoqeU9UqtpiWC9lcAohg.png)

Next, we’ll log in to our Netlify account via the CLI. Type in the command `netlify login`.

![Image showing a command prompt using the Netlify login command.](/static/images/blog/contents/1_hTlkopNl0J7f6hWsu04Bqw.png)
...
![Image showing the authorize application prompt by Netlify.](/static/images/blog/contents/1_PoBVVtGyRpQOxfsFVm36Zw.png)
...
![Image showing the command to create a new empty site in Netlify.](/static/images/blog/contents/1_B_hTgi0SstvgR8-NuNu1JA.png)
...
![Image showing how to capture the site ID from Netlify.](/static/images/blog/contents/1_QwT-I6Mrdj0LCIbBTCTbxw.png)
...
![](/static/images/blog/contents/1_nI303WVwcc8Y2pP7uEXFoQ.png)
...
![Image showing the release variables in Azure DevOps.](/static/images/blog/contents/1_QFAfHMgrtdncV9J_mBkorA.png)

#### **Give it a go!**

Now, create a new release and watch the magic happen. This is what my demo website looks like once deployed:

![Image showing the demo website.](/static/images/blog/contents/1_MzTjEnoaYM05tHFq0NfPzA.png)
...
![Image showing how to inject a snippet in Netlify.](/static/images/blog/contents/1_xKQbHWnBfHhLpjqqVAwb_w.png)
...
![Image showing a snippet to disallow search engines from crawling the website.](/static/images/blog/contents/1_L3o1lrbFuPV6YvHJU-n-zQ.png)
