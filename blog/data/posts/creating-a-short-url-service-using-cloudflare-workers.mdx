...
images: ['/static/images/blog/guidepost1.jpg']
---

<InlineImage
  src="/static/images/blog/guidepost1.jpg"
  alt="An image of a directional post as the featured image for this article."
  caption={
    <>
      Image source: <a href="https://unsplash.com/photos/rzJKYpq2is4">Unsplash</a>
    </>
  }
/>
...
![Screenshot showing how to access Cloudflare Workers.](/static/images/blog/contents/1_l5vratkH9Ls6vBw7gUyg_w.png)
...
![Screenshot showing how to configure a subdomain for Cloudflare Workers.](/static/images/blog/contents/1_UX8yzI1rPWIC2JUFjPihFQ.png)
...
![Screenshot showing how to get the account ID from Cloudflare.](/static/images/blog/contents/1_fac3j6pJ7ivpLo0y5vMyHg.png)
...
![Screenshot showing the console output of the entered wrangler commands.](/static/images/blog/contents/1_X_nQAkFFOE6r5VR4t3hdVA.png)
...
![Screenshot showing the Worker in action locally.](/static/images/blog/contents/1_gV1OJWEoMxWjjxqIorEwsA.png)
...
![Screenshot showing the console output of the entered wrangler commands.](/static/images/blog/contents/1_g_EX-IiZwPppI7nZ-AuL6A.png)
...
> Error: In order to preview a worker with KV namespaces, you must designate a preview_id in your configuration file for each KV namespace \
> you’d like to preview.

![Screenshot showing the console output of the entered wrangler commands.](/static/images/blog/contents/1_fyYIgdq1T1kMKjppIfD7sg.png)
...
![Screenshot showing the console output of the entered wrangler commands.](/static/images/blog/contents/1_X0Y7qIFeesMrK5ZgEr_HGg.png)
...
![GIF showing the redirection in action.](/static/images/blog/contents/1_BWD9UbqD9m_K4gjQWvcIpQ.gif)
...
![Screenshot showing how to create a new API token.](/static/images/blog/contents/1_uHucyp-XXEn32Rqvqfhm0g.png)

From the API token templates page, we’ll click on the **Use template** button beside the **Edit Cloudflare Workers** line item.

![Screenshot showing how to use an existing template to create an API token.](/static/images/blog/contents/1_4U7ZaLs4jxiN8oTsWbnUfQ.png)
...
![Screenshot showing how to create a token in Cloudflare.](/static/images/blog/contents/1_F6E6VF-kO35iqU9rC98DCg.png)
...
![Screenshot showing how to add a secret in GitHub.](/static/images/blog/contents/1_aBbi8J8rKopUZWBPw3A3Bw.png)
...
![Screenshot of the GitHub Actions tab.](/static/images/blog/contents/1_y69YYHGn9fnNC6m3hgdQmw.png)
...
![Image showing how to see the Worker in the Cloudflare dashboard.](/static/images/blog/contents/1_y7ffTi0BLi-TPSJ6ha9jPA.png)
...
![GIF showing the redirection in action.](/static/images/blog/contents/1_YHmeK66PEc-RGyQSIFXtug.gif)
...
![Diagram showing how multiple Workers come together to form a complete solution.](/static/images/blog/contents/1_YC-pmfE9i4QZI3qw_HumJQ.png)
...
![Diagram showing how to host multiple workers in the same repository.](/static/images/blog/contents/1_t6vUl_1ITc5D_P3GpKRS3w.png)
...
![High-level architecture diagram showing all components involved in a full-fledged short URL service.](/static/images/blog/contents/1*cxAr7Kz9jvQZe2y0BxMAEQ.png)
