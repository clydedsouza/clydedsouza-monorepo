...
images: ['/static/images/blog/teamcity.png']
---

<InlineImage
  src="/static/images/blog/teamcity.png"
...
![Image of a command prompt showing the output of a command that has been run.](https://cdn-images-1.medium.com/max/800/1*AxNISKdw4pJ1Quj6suTNdg.png)
...
![Screenshot showing TeamCity’s start page.](https://cdn-images-1.medium.com/max/800/1*skBRZXqJEqBr4G1K6_WubQ.png)

TeamCity will now initialize the data directory and will reload the page automatically.

![Screenshot of TeamCity setting things up.](https://cdn-images-1.medium.com/max/800/1*1WKAHEShb4tmZR2txnZaYQ.png)
...
![Screenshot of TeamCity’s database connection setup.](https://cdn-images-1.medium.com/max/800/1*rxhZ5S3pkO8hNXiAtsKMEA.png)
...
![Screenshot of TeamCity starting up.](https://cdn-images-1.medium.com/max/800/1*QDAAjj8zllqH_rO0FuVvQA.png)
...
![Partial screenshot of TeamCity’s agreement.](https://cdn-images-1.medium.com/max/800/1*Fm0R4ndotMudISmbGkN4aQ.png)
...
![Screenshot of TeamCity’s create administrator account page.](https://cdn-images-1.medium.com/max/800/1*v6Z346BE-iS5XGiAUfFHug.png)
...
![Screenshot showing how to enable experimental UI.](https://cdn-images-1.medium.com/max/800/1*xGAcwCAXcENfW6zm4dLdCw.png)
...
![Screenshot showing how to download TeamCity’s Windows installer software.](https://cdn-images-1.medium.com/max/800/1*x02wm1RxsddEjhKT4xH8yQ.png)
...
![Screenshot showing how to configure a local TeamCity build agent.](https://cdn-images-1.medium.com/max/800/1*xNtJXqEbLRNr98LMrKFzRA.png)
...
![Screenshot showing the TeamCity build agent service running as a Windows service.](https://cdn-images-1.medium.com/max/800/1*d8YNL8YbD_CLCbwIWePCqA.png)
...
![Screenshot showing how to authorize the newly added build agent.](https://cdn-images-1.medium.com/max/800/1*90HTXRZhVBuWf8R17k-HWw.png)
...
![Screenshot show the authorize build agent pop up.](https://cdn-images-1.medium.com/max/800/1*IwiwT7OuJNrJf4ONV3r3lA.png)
...
![Screenshot showing how to generate a personal access token in GitHub.](https://cdn-images-1.medium.com/max/800/1*iya55tvGkM83vAavfmYcXA.png)
...
![Screenshot showing how to create a project in TeamCity.](https://cdn-images-1.medium.com/max/800/1*XlzHAftCJNuvwRYgqFW5IA.png)
...
![Screenshot showing how to create a project in TeamCity.](https://cdn-images-1.medium.com/max/800/1*6cdu8DkV4_FS3YH8yu6uWQ.png)
...
![Screenshot showing how to create a project in TeamCity.](https://cdn-images-1.medium.com/max/800/1*QAs6KfdIuIAMLGLC6SrhWQ.png)
...
![Screenshot showing how to configure the build steps manually in TeamCity.](https://cdn-images-1.medium.com/max/1200/1*gN8rNeTn_Mfi7j7Pp2pVWw.png)
...
![Screenshot showing how to add a command line hello world build step in TeamCity.](https://cdn-images-1.medium.com/max/800/1*JBQgFY16or0AlH48MuLR2g.png)

We’re expecting the build to print a ‘Hello world!’ message. Click on the **Run** button to trigger a build and test this theory.

![Screenshot showing how to run your first build in TeamCity.](https://cdn-images-1.medium.com/max/1200/1*Q6fvgoxrN-qfzJJScIBs9Q.png)
...
![Screenshot showing to access the build logs of a particular build in TeamCity.](https://cdn-images-1.medium.com/max/1200/1*H0IlZfgpoxKsuYOf9tJLAg.png)
...
![Screenshot showing to access the build logs of a particular build in TeamCity.](https://cdn-images-1.medium.com/max/800/1*j_cZOEpnIzsc3YYfSJ-EAg.png)
...
![Screenshot showing how to create a new user in TeamCity.](https://cdn-images-1.medium.com/max/1200/1*aB41JGxDU2_8-WyiazQp8g.png)
...
![Screenshot showing how to create a new user in TeamCity.](https://cdn-images-1.medium.com/max/800/1*5t7jyKiJacqTBt0VH39uug.png)

Now that we’ve created this new user, let’s log in using this account to confirm we have access.

![Screenshot showing TeamCity’s login page.](https://cdn-images-1.medium.com/max/800/1*B7kOmejv_BtoiWXzXDytKw.png)

Voila! You should now have access to the TeamCity server using the newly created account.

![Screenshot of TeamCity’s project page.](https://cdn-images-1.medium.com/max/800/1*jHWrkFOXPDrpHATX9Hhmpg.png)
...
![Screenshot showing how to start a Docker container.](https://cdn-images-1.medium.com/max/1200/1*9CshpkBdMnYvUL762DO1BA.png)
...
![Screenshot showing how to stop and delete a Docker container.](https://cdn-images-1.medium.com/max/1200/1*ylNQTYYI_Wz-W1tgRNdnWg.png)
...
![Screenshot showing how to stop the TeamCity build agent.](https://cdn-images-1.medium.com/max/800/1*MTWFrNdynm6cJ6p_MWvFRQ.png)
...
![Screenshot showing how to uninstall TeamCity build agent.](https://cdn-images-1.medium.com/max/800/1*GjBy6OlomKZ6bjWAwIzfFg.png)
