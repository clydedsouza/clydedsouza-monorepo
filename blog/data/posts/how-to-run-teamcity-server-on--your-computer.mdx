...
![Image of a command prompt showing the output of a command that has been run.](/static/images/blog/contents/1_AxNISKdw4pJ1Quj6suTNdg.png)
...
![Screenshot showing TeamCity’s start page.](/static/images/blog/contents/1_skBRZXqJEqBr4G1K6_WubQ.png)

TeamCity will now initialize the data directory and will reload the page automatically.

![Screenshot of TeamCity setting things up.](/static/images/blog/contents/1_1WKAHEShb4tmZR2txnZaYQ.png)
...
![Screenshot of TeamCity’s database connection setup.](/static/images/blog/contents/1_rxhZ5S3pkO8hNXiAtsKMEA.png)
...
![Screenshot of TeamCity starting up.](/static/images/blog/contents/1_QDAAjj8zllqH_rO0FuVvQA.png)
...
![Partial screenshot of TeamCity’s agreement.](/static/images/blog/contents/1_Fm0R4ndotMudISmbGkN4aQ.png)
...
![Screenshot of TeamCity’s create administrator account page.](/static/images/blog/contents/1_v6Z346BE-iS5XGiAUfFHug.png)
...
![Screenshot showing how to enable experimental UI.](/static/images/blog/contents/1_xGAcwCAXcENfW6zm4dLdCw.png)
...
![Screenshot showing how to download TeamCity’s Windows installer software.](/static/images/blog/contents/1_x02wm1RxsddEjhKT4xH8yQ.png)
...
![Screenshot showing how to configure a local TeamCity build agent.](/static/images/blog/contents/1_xNtJXqEbLRNr98LMrKFzRA.png)
...
![Screenshot showing the TeamCity build agent service running as a Windows service.](/static/images/blog/contents/1_d8YNL8YbD_CLCbwIWePCqA.png)
...
![Screenshot showing how to authorize the newly added build agent.](/static/images/blog/contents/1_90HTXRZhVBuWf8R17k-HWw.png)
...
![Screenshot show the authorize build agent pop up.](/static/images/blog/contents/1_IwiwT7OuJNrJf4ONV3r3lA.png)
...
![Screenshot showing how to generate a personal access token in GitHub.](/static/images/blog/contents/1_iya55tvGkM83vAavfmYcXA.png)
...
![Screenshot showing how to create a project in TeamCity.](/static/images/blog/contents/1_XlzHAftCJNuvwRYgqFW5IA.png)
...
![Screenshot showing how to create a project in TeamCity.](/static/images/blog/contents/1_6cdu8DkV4_FS3YH8yu6uWQ.png)
...
![Screenshot showing how to create a project in TeamCity.](/static/images/blog/contents/1_QAs6KfdIuIAMLGLC6SrhWQ.png)
...
![Screenshot showing how to configure the build steps manually in TeamCity.](/static/images/blog/contents/1_gN8rNeTn_Mfi7j7Pp2pVWw.png)
...
![Screenshot showing how to add a command line hello world build step in TeamCity.](/static/images/blog/contents/1_JBQgFY16or0AlH48MuLR2g.png)

We’re expecting the build to print a ‘Hello world!’ message. Click on the **Run** button to trigger a build and test this theory.

![Screenshot showing how to run your first build in TeamCity.](/static/images/blog/contents/1_Q6fvgoxrN-qfzJJScIBs9Q.png)
...
![Screenshot showing to access the build logs of a particular build in TeamCity.](/static/images/blog/contents/1_H0IlZfgpoxKsuYOf9tJLAg.png)
...
![Screenshot showing to access the build logs of a particular build in TeamCity.](/static/images/blog/contents/1_j_cZOEpnIzsc3YYfSJ-EAg.png)
...
![Screenshot showing how to create a new user in TeamCity.](/static/images/blog/contents/1_aB41JGxDU2_8-WyiazQp8g.png)
...
![Screenshot showing how to create a new user in TeamCity.](/static/images/blog/contents/1_5t7jyKiJacqTBt0VH39uug.png)

Now that we’ve created this new user, let’s log in using this account to confirm we have access.

![Screenshot showing TeamCity’s login page.](/static/images/blog/contents/1_B7kOmejv_BtoiWXzXDytKw.png)

Voila! You should now have access to the TeamCity server using the newly created account.

![Screenshot of TeamCity’s project page.](/static/images/blog/contents/1_jHWrkFOXPDrpHATX9Hhmpg.png)
...
![Screenshot showing how to start a Docker container.](/static/images/blog/contents/1_9CshpkBdMnYvUL762DO1BA.png)
...
![Screenshot showing how to stop and delete a Docker container.](/static/images/blog/contents/1_ylNQTYYI_Wz-W1tgRNdnWg.png)
...
![Screenshot showing how to stop the TeamCity build agent.](/static/images/blog/contents/1_MTWFrNdynm6cJ6p_MWvFRQ.png)
...
![Screenshot showing how to uninstall TeamCity build agent.](/static/images/blog/contents/1_GjBy6OlomKZ6bjWAwIzfFg.png)
