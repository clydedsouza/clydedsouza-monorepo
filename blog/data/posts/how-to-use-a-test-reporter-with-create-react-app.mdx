...
![Screenshot of all unit tests passing](/static/images/blog/contents/1_ZAB8IxqcPFRvV1Ag5XBgIw.png)
...
![Screenshot of what a junit.xml file looks like](/static/images/blog/contents/1_bX9dCRj-JN3s-zt-rNU1tw.png)
...
![Screenshot of test coverage results printed in the console](/static/images/blog/contents/1_YpqwNgVGaEQc163UqTKh5A.png)

Your code coverage results are also produced in the coverage folder like the screenshot below.

![Screenshot of the coverage folder including test coverage files](/static/images/blog/contents/1_YguU_eZudlxQc-4KOvNniw.png)
