...
![Image showing the error message when trying to publish a large VSIX package.](/static/images/blog/contents/1_PlQ3v4NYeYq9ua3BCzOXjg.png)
...
![Image showing the size of the original VSIX package.](/static/images/blog/contents/1_fnVLcgc-igVpmcjyfzGTTw.png)
...
![Image showing the contents of the buildAndReleaseTask folder.](/static/images/blog/contents/1_A7mkKtLNbGx34FTIkNw3GQ.png)
...
![Image showing the size of the node_modules folder before the modclean process.](/static/images/blog/contents/1_JKEbvKJFgeNmd1iqhVq9_w.png)
...
![Image showing the size of the node_modules folder after the modclean process.](/static/images/blog/contents/1_AZXgFpIwKnb19uZDug0LWw.png)
...
![Image showing the file size of the VSIX package after the modclean process.](/static/images/blog/contents/1_paEBn_EYabTvP4orgvOOPQ.png)
...
![Images showing the contents of the buildAndReleaseTask folder and a cross mark indicating the contents to be deleted.](/static/images/blog/contents/1_IWoQmI6ngeS-AfGxmCe0Bg.png)
...
![Before and after picture of the file size of the buildAndReleaseTask folder.](/static/images/blog/contents/1_hOP5plCyV-NGNcIoTynfew.png)
...
![Images show three command-line tasks to perform modclean and development files cleanup.](/static/images/blog/contents/1_Y7qeRvbQdyL36boOTAepiw.png)
...
![Before and after picture of the drop folder from the Azure DevOps build pipeline.](/static/images/blog/contents/1_6VZTrxNrwh6-tF8G7wSMgA.png)
...
![](/static/images/blog/contents/1_MkDrEQvGJA_wnUJSSS1sXQ.png)
