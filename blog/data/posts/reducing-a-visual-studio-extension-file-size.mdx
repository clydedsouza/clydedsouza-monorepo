...
![Image showing the error message when trying to publish a large VSIX package.](https://cdn-images-1.medium.com/max/800/1*PlQ3v4NYeYq9ua3BCzOXjg.png)
...
![Image showing the size of the original VSIX package.](https://cdn-images-1.medium.com/max/800/1*fnVLcgc-igVpmcjyfzGTTw.png)
...
![Image showing the contents of the buildAndReleaseTask folder.](https://cdn-images-1.medium.com/max/800/1*A7mkKtLNbGx34FTIkNw3GQ.png)
...
![Image showing the size of the node_modules folder before the modclean process.](https://cdn-images-1.medium.com/max/800/1*JKEbvKJFgeNmd1iqhVq9_w.png)
...
![Image showing the size of the node_modules folder after the modclean process.](https://cdn-images-1.medium.com/max/800/1*AZXgFpIwKnb19uZDug0LWw.png)
...
![Image showing the file size of the VSIX package after the modclean process.](https://cdn-images-1.medium.com/max/800/1*paEBn_EYabTvP4orgvOOPQ.png)
...
![Images showing the contents of the buildAndReleaseTask folder and a cross mark indicating the contents to be deleted.](https://cdn-images-1.medium.com/max/800/1*IWoQmI6ngeS-AfGxmCe0Bg.png)
...
![Before and after picture of the file size of the buildAndReleaseTask folder.](https://cdn-images-1.medium.com/max/800/1*hOP5plCyV-NGNcIoTynfew.png)
...
![Images show three command-line tasks to perform modclean and development files cleanup.](https://cdn-images-1.medium.com/max/800/1*Y7qeRvbQdyL36boOTAepiw.png)
...
![Before and after picture of the drop folder from the Azure DevOps build pipeline.](https://cdn-images-1.medium.com/max/800/1*6VZTrxNrwh6-tF8G7wSMgA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*MkDrEQvGJA_wnUJSSS1sXQ.png)
