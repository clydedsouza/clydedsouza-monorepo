...
readingList: []
draft: false
summary: 'When your demo application has no real users'
images: ['/static/images/blog/roads.jpg']
---

<InlineImage
  src="/static/images/blog/roads.jpg"
...
![Image showing the create resource page of a Logic App.](/static/images/blog/contents/1_hNQ-44NN3EKt2deu1_Mv3A.png)
...
![Image showing the fields that needs to be populated to create a Logic App.](/static/images/blog/contents/1_ZivaWUanD1y4XliaxegjGg.png)
...
![Image showing what trigger to select for this Logic App.](/static/images/blog/contents/1_Kd1dZM9ZIUR1HR7IypGG2g.png)
...
![Image showing how to configure the trigger for this Logic App.](/static/images/blog/contents/1_IDNSKLuUe5BiCTdD4Ue6yg.png)
...
![Image showing what the trigger should look like for this Logic App.](/static/images/blog/contents/1_Mhm5OSPF5vA6o8vuIRE_aA.png)
...
![Image showing how to select the HTTP action for our Logic App.](/static/images/blog/contents/1_tCDO9X00l1cs22R6St-YOg.png)
...
![Image showing how to configure the HTTP action for our Logic App.](/static/images/blog/contents/1_eanqy4a4X4W8eRTvJ7clUg.png)

Image courtesy of the author

Don’t forget to hit the **Save** button regularly to save your progress.

![Image showing how to save a Logic App.](/static/images/blog/contents/1_OsxVaM40-nnP4L2PpOqrvw.png)
...
![Image showing how to test run the Logic App.](/static/images/blog/contents/1_1xyqh21B0ODoNVP-i27dYg.png)
...
![Image showing the output after a test run of our Logic App.](/static/images/blog/contents/1_sq0b11M-5FG7SiC_pktU1g.png)
...
![Image showing how to add another step in our Logic App.](/static/images/blog/contents/1_bhKfhcuMNYx7vNIHNF_6ZQ.png)
...
![Image showing how to add a parallel step in our Logic App.](/static/images/blog/contents/1_h_xWy9KDti5R7_6P70y4EQ.png)
...
![Image showing what the final Logic App would look like.](/static/images/blog/contents/1_WKeSPP_EMQvttdI2Yx6y6g.png)
...
![Image showing how to monitor our Logic App.](/static/images/blog/contents/1_xkXiFrIIuavZuffvnMfWfw.png)
...
![Image showing how to rename a step in the Logic App.](/static/images/blog/contents/1_fB8-teRkSXlxVwP65qTuxQ.png)
...
![Image showing what a well named Logic App would look like.](/static/images/blog/contents/1_EwB-j380KYVoZS3asIY97Q.png)
...
![Image showing how to access the code view in a Logic App.](/static/images/blog/contents/1_5WZQCMdngRXxyFsXERMtMA.png)
...
![Image showing how to add a parameter in the Logic App.](/static/images/blog/contents/1_a_QS89GXvKcgIWsIK7aA-g.png)
...
![Image showing how to configure a parameter in a Logic App.](/static/images/blog/contents/1_ILkFuXymB4Y3PgoUNZRGeQ.png)
...
![Image showing how to use a parameter in a step in the Logic App.](/static/images/blog/contents/1_FnvZCiAnA6lSAOWrs4j_-Q.png)
