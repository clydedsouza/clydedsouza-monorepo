...
date: '2020-12-16'
lastmod: '2020-12-16'
tags: ['Azure', 'wordpress', 'Azure App Service']
readingList: []
draft: false
summary: 'Spin up a WordPress website within minutes'
images: ['/static/images/blog/wordpressazure.png']
---

<InlineImage
  src="/static/images/blog/wordpressazure.png"
...
![Selecting WordPress from the Azure Marketplace](https://cdn-images-1.medium.com/max/1200/1*rI810HalROgYn3N8R7gHUg.png)
...
![Configuring an App Service in Azure](https://cdn-images-1.medium.com/max/800/1*QFFcs72I5JCbTjWYiXKpnw.png)
...
![Selecting MySQL In App from the list of database providers in Azure](https://cdn-images-1.medium.com/max/800/1*kjHAGU5xuf84zNCi7kKoCw.png)
...
![Selecting your WordPress language during installation](https://cdn-images-1.medium.com/max/800/1*ydD_cPGkavKqwWQqHuEHag.png)
...
![Configuring site information in WordPress during installation](https://cdn-images-1.medium.com/max/800/1*6ei558MzF9Ai2Xdw8s9GIg.png)

Click on the **Install WordPress** button to begin the famous 5-minute WordPress installation.

![Image of successful WordPress installation](https://cdn-images-1.medium.com/max/800/1*772FiBlVp57io4kdR9Gbbg.png)

Click on the **Log In** button to head over to the login screen.

![Login to WordPress](https://cdn-images-1.medium.com/max/800/1*2n9cz7J9ajpe2PRE2roR9g.png)
...
![Image of WordPress dashboard](https://cdn-images-1.medium.com/max/800/1*LIDCmPUv4Bt8IT_iVz1zKg.png)
...
![Image showing how to access phpMyAdmin portal](https://cdn-images-1.medium.com/max/800/1*WBrHf8anBei-aYHhJbh2QA.png)
...
![Image of phpMyAdmin portal](https://cdn-images-1.medium.com/max/800/1*H9ZSuSU80cFyrVYuNIyD4w.png)
