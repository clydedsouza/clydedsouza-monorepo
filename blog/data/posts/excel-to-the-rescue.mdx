...
![Sample Excel list of data](/static/images/blog/contents/1_rFt5Wk0c9TfhTNRj7po9CQ.png)
...
![Image of the formula applied in the cell D2 of the Excel file](/static/images/blog/contents/1_nDLf8_9CaxXpDVRff7SXEA.png)
...
![GIF showing how to apply the formula and drag it down for all records](/static/images/blog/contents/1_raAmZDxoVCaB6tPNl0CW_Q.gif)
...
![Image of the SQL statement in HeidiSQL with steps annotated](/static/images/blog/contents/1_7ASFX-ymrxMgfQJokIytvw.png)

Click the **Data** tab to see all the values inserted into the table.

![Image of the data contained in the table and viewed using HeidiSQL](/static/images/blog/contents/1_V8HY3nlUGOEgigoHTrM8-g.png)
