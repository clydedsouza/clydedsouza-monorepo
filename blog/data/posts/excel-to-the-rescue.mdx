...
readingList: []
draft: false
summary: 'Creating SQL statements using Excel formulas'
images: ['/static/images/blog/excel.png']
---

<InlineImage
  src="/static/images/blog/excel.png"
...
![Sample Excel list of data](https://cdn-images-1.medium.com/max/800/1*rFt5Wk0c9TfhTNRj7po9CQ.png)
...
![Image of the formula applied in the cell D2 of the Excel file](https://cdn-images-1.medium.com/max/800/1*nDLf8_9CaxXpDVRff7SXEA.png)
...
![GIF showing how to apply the formula and drag it down for all records](https://cdn-images-1.medium.com/max/800/1*raAmZDxoVCaB6tPNl0CW_Q.gif)
...
![Image of the SQL statement in HeidiSQL with steps annotated](https://cdn-images-1.medium.com/max/800/1*7ASFX-ymrxMgfQJokIytvw.png)

Click the **Data** tab to see all the values inserted into the table.

![Image of the data contained in the table and viewed using HeidiSQL](https://cdn-images-1.medium.com/max/800/1*V8HY3nlUGOEgigoHTrM8-g.png)
...
Thanks for reading. Share it with your network 🙏
