...
![Click on options to open the Demo Monkey portal.](/static/images/blog/contents/1_Xk1yaY17Q-yBic7El3Ndrw.png)
...
![Grant permissions for Demo Monkey to access all sites.](/static/images/blog/contents/1_yzc8sponx1PSf2Lo-Yuurw.png)
...
![Image showing how to update the default script.](/static/images/blog/contents/1_b-oMRBo4NQBf9GPZnQefzA.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_jVF9Juku11dolzqMlnTfSw.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_sHilDzAeMOvjzg5S8Anjew.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_0L62-sLjPsgZHkGLFI8GEw.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_vl2_6qUKUb2BSaCA42NLKw.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_AhCy8Otg2TAtBodp3FTn-w.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_4EKZCQNnPtAjOgAzIKAv6Q.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_TFgug6qBC24mW9xueZVlVA.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_80ZwNZDckUCUVi40Vs4v0g.png)
...
![GIF showing this change in action.](/static/images/blog/contents/1_t4hCEOGV_WcoliwU9DxelQ.gif)
...
![Image showing a warning message.](/static/images/blog/contents/1_hW-abYIkyNZSFiTb1RdR8w.png)

While still in the Demo Monkey portal, click on **Settings** and turn the **Hook into Web Requests** flag on.

![Image showing how to enable Hook into web requests.](/static/images/blog/contents/1__MK4xoLI9AHDfrYaxLq27g.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_1tcOYAFkkasomuQmmLNOiA.png)
...
![Image showing this change in action.](/static/images/blog/contents/1_aSnP_BfgttsFI2PI37MYNQ.png)
...
![Before and after image for this change.](/static/images/blog/contents/1_byc4ZiQioIJf6FYrcQewEw.png)
...
![Image showing this change in action.](/static/images/blog/contents/1_AWvKOa0UnIrUipzx_NN_UA.png)
