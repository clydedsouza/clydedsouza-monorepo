...
subtitle: >-
  Written in TypeScript, using Bolt JS framework and sprinkled with developer
  tips along the way
date: '2021-04-25'
lastmod: '2021-04-25'
tags:
...
draft: false
images:
  - /static/posts/slackbot.png
---

<InlineImage
  src="/static/posts/slackbot.png"
...
![High-level design diagram outlining how all the components interact with each other.](/static/posts/1_dJWWf9zXEQCz1BYB2I0GhA.png)
...
![Screenshot showing how to create a new site in Netlify from a git repo.](/static/posts/1_A5IhUGb17M6u8wzxRY3brA.png)
...
![Screenshot showing how to connect GitHub with Netlify.](/static/posts/1_X5TUyJ6GD1IUOYFhwjXxrg.png)
...
![Screenshot showing how to install Netlify in GitHub.](/static/posts/1_wfOyWLrWnCp9h-ca6Ja2ew.png)
...
![Screenshot showing how to install Netlify in GitHub.](/static/posts/1_orF_skLkhctOvk4E2nyYnA.png)
...
![Screenshot showing how to connect GitHub with Netlify and pick a repository to sync with Netlify.](/static/posts/1_FSGtWGEJMyPyAW6Prm8IVg.png)
...
![Screenshot showing how to update the site name in Netlify.](/static/posts/1_HFlTfJYsa0JrnzABmyjPVw.png)

Image courtesy of the author

Enter your new site name in the pop-up and click on the **Save** button.

![Screenshot showing how to update the site name in Netlify.](/static/posts/1_NWkku41v_il6eoN4E_GeUw.png)
...
![Screenshot showing how to link a local code repository with Netlify](/static/posts/1_jxZQpRQ6OYTrk5dy5Ka8LQ.png)
...
![Screenshot showing how to test a Netlify Function locally.](/static/posts/1_Jt5Cdu1solN52zvq52IRsA.png)
...
![Screenshot showing the Netlify site build history.](/static/posts/1_u1gnlExfd-GHiorTapt97w.png)
...
![Screenshot showing how to test a Netlify Function on the web.](/static/posts/1_cFniHY0uhcsR7LsXZhyNig.png)
...
![Screenshot showing how to create an app in Slack.](/static/posts/1_k6e5VMKzAWi6LqzQBLrP-g.png)
...
![Screenshot showing how to add an OAuth scope to your Slack app.](/static/posts/1_G41M2tnxpzGEzwPO1RGHnA.png)
...
![Screenshot showing how to install the Slack app in your workspace and get your bot token.](/static/posts/1_k4GTW0YqpG9ao1K5T4PQ1Q.png)
...
![Screenshot showing how to get the signing secret value.](/static/posts/1_lKOxwKapIu5AiChCHvAaNQ.png)
...
![Screenshot showing how to add the bot token and signing secret value in the env file of your app.](/static/posts/1_6YeJzWaqbltJmGITP4TX_A.png)
...
![Screenshot showing how to add environment variables in Netlify.](/static/posts/1_YADT_bldPiu4w4TmICmVtg.png)
...
![Screenshot showing how to enable event subscriptions and add the request URL.](/static/posts/1_ZcsKdUfqvL4j39BMSiebfw.png)
...
![Screenshot showing how to subscribe to bot events.](/static/posts/1_JjXS6W6UspfJUUEsJqncsA.png)
...
![Screenshot showing the demo Slack app in action.](/static/posts/1_uR30gk6xOOX7hK_PUVDXUg.png)
...
![Screenshot showing how to create a new slash command in Slack.](/static/posts/1_KSnKMXrlFMB55QTDMd8Xzw.png)
...
![Screenshot showing how to create a new slash command in Slack.](/static/posts/1_XawsiXDpk5Ksjz4Bw1zvXQ.png)
...
![Screenshot showing how to test the slash command in Slack.](/static/posts/1_M-4FakQ_pVdu-AJigztRIQ.png)
...
![Screenshot showing the demo Slack app in action.](/static/posts/1_OZ9AvbT9na62azw7nqzG4g.png)
...
![Screenshot illustrating the directory change in the cleaned-up version of the source code.](/static/posts/1_4zJo1mveRxgzSHlR0UArTA.png)
