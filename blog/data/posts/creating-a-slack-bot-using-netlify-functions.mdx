...
![High-level design diagram outlining how all the components interact with each other.](https://cdn-images-1.medium.com/max/800/1*dJWWf9zXEQCz1BYB2I0GhA.png)
...
![Screenshot showing how to create a new site in Netlify from a git repo.](https://cdn-images-1.medium.com/max/800/1*A5IhUGb17M6u8wzxRY3brA.png)
...
![Screenshot showing how to connect GitHub with Netlify.](https://cdn-images-1.medium.com/max/800/1*X5TUyJ6GD1IUOYFhwjXxrg.png)
...
![Screenshot showing how to install Netlify in GitHub.](https://cdn-images-1.medium.com/max/800/1*wfOyWLrWnCp9h-ca6Ja2ew.png)
...
![Screenshot showing how to install Netlify in GitHub.](https://cdn-images-1.medium.com/max/800/1*orF_skLkhctOvk4E2nyYnA.png)
...
![Screenshot showing how to connect GitHub with Netlify and pick a repository to sync with Netlify.](https://cdn-images-1.medium.com/max/800/1*FSGtWGEJMyPyAW6Prm8IVg.png)
...
![Screenshot showing how to update the site name in Netlify.](https://cdn-images-1.medium.com/max/800/1*HFlTfJYsa0JrnzABmyjPVw.png)

Image courtesy of the author

Enter your new site name in the pop-up and click on the **Save** button.

![Screenshot showing how to update the site name in Netlify.](https://cdn-images-1.medium.com/max/800/1*NWkku41v_il6eoN4E_GeUw.png)
...
![Screenshot showing how to link a local code repository with Netlify](https://cdn-images-1.medium.com/max/800/1*jxZQpRQ6OYTrk5dy5Ka8LQ.png)
...
![Screenshot showing how to test a Netlify Function locally.](https://cdn-images-1.medium.com/max/800/1*Jt5Cdu1solN52zvq52IRsA.png)
...
![Screenshot showing the Netlify site build history.](https://cdn-images-1.medium.com/max/800/1*u1gnlExfd-GHiorTapt97w.png)
...
![Screenshot showing how to test a Netlify Function on the web.](https://cdn-images-1.medium.com/max/800/1*cFniHY0uhcsR7LsXZhyNig.png)
...
![Screenshot showing how to create an app in Slack.](https://cdn-images-1.medium.com/max/800/1*k6e5VMKzAWi6LqzQBLrP-g.png)
...
![Screenshot showing how to add an OAuth scope to your Slack app.](https://cdn-images-1.medium.com/max/800/1*G41M2tnxpzGEzwPO1RGHnA.png)
...
![Screenshot showing how to install the Slack app in your workspace and get your bot token.](https://cdn-images-1.medium.com/max/800/1*k4GTW0YqpG9ao1K5T4PQ1Q.png)
...
![Screenshot showing how to get the signing secret value.](https://cdn-images-1.medium.com/max/800/1*lKOxwKapIu5AiChCHvAaNQ.png)
...
![Screenshot showing how to add the bot token and signing secret value in the env file of your app.](https://cdn-images-1.medium.com/max/800/1*6YeJzWaqbltJmGITP4TX_A.png)
...
![Screenshot showing how to add environment variables in Netlify.](https://cdn-images-1.medium.com/max/800/1*YADT_bldPiu4w4TmICmVtg.png)
...
![Screenshot showing how to enable event subscriptions and add the request URL.](https://cdn-images-1.medium.com/max/800/1*ZcsKdUfqvL4j39BMSiebfw.png)
...
![Screenshot showing how to subscribe to bot events.](https://cdn-images-1.medium.com/max/800/1*JjXS6W6UspfJUUEsJqncsA.png)
...
![Screenshot showing the demo Slack app in action.](https://cdn-images-1.medium.com/max/800/1*uR30gk6xOOX7hK_PUVDXUg.png)
...
![Screenshot showing how to create a new slash command in Slack.](https://cdn-images-1.medium.com/max/800/1*KSnKMXrlFMB55QTDMd8Xzw.png)
...
![Screenshot showing how to create a new slash command in Slack.](https://cdn-images-1.medium.com/max/800/1*XawsiXDpk5Ksjz4Bw1zvXQ.png)
...
![Screenshot showing how to test the slash command in Slack.](https://cdn-images-1.medium.com/max/800/1*M-4FakQ_pVdu-AJigztRIQ.png)
...
![Screenshot showing the demo Slack app in action.](https://cdn-images-1.medium.com/max/800/1*OZ9AvbT9na62azw7nqzG4g.png)
...
![Screenshot illustrating the directory change in the cleaned-up version of the source code.](https://cdn-images-1.medium.com/max/1200/1*4zJo1mveRxgzSHlR0UArTA.png)
