...
readingList: []
draft: false
summary: '#6 Yugen — An appreciation for the profound and mysterious'
...
![Yugen (幽玄) / Image source: Unsplash / Made using Figma](/static/images/blog/contents/1_VeBGi8R_H_G-DlTvNfHTDw.png)
...
![Gaman (我慢) / Image source: Unsplash / Made using Figma](/static/images/blog/contents/1_2nd0gzW9x8cNweekKQZbCw.png)
...
![Fukinsei (不均整) / Image source: Unsplash / Made using Figma](/static/images/blog/contents/1_D3HXePa1doyfWJ1Pe4QGcQ.png)
...
![Ma (間) / Image source: Unsplash / Made using Figma](/static/images/blog/contents/1_KfR2k8MYW-TYtrwgWmKODQ.png)
...
![Shikata ga nai (仕方がない) / Image source: Unsplash / Made using Figma](/static/images/blog/contents/1_ATDWdutomvvYJ3hwQcieQg.png)
...
![Kaizen (改善) / Image source: Unsplash / Made using Figma](/static/images/blog/contents/1_YsAw2jTfn4A6pgzmnX9KQQ.png)
