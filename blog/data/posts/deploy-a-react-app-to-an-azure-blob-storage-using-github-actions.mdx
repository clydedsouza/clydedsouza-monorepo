...
![Screenshot showing the output of an Azure CLI command.](/static/images/blog/contents/1_KGRXU4fHdE0Pn9kB53di1g.png)
...
![Screenshot showing the output of an Azure CLI command.](/static/images/blog/contents/1_XvDsvmJZRZ3eOgnlCdbYZg.png)
...
![Screenshot showing the output of an Azure CLI command.](/static/images/blog/contents/1_JY3VVZAgOXpvsnIHw3z5Lw.png)
...
![Screenshot showing the output of an Azure CLI command.](/static/images/blog/contents/1_s_fdhrTMJYEN_C2oEXAO9g.png)
...
![Screenshot showing how to enable static site on a storage account via the Azure portal.](/static/images/blog/contents/1_h1KtkgEVDjLub9GtT6k83g.png)
...
![Screenshot showing the options available after enabling static site on a storage account.](/static/images/blog/contents/1__fhnwf9IqIIKvUculxwqew.png)
...
![Screenshot showing the output of an Azure CLI command.](/static/images/blog/contents/1_jp8V-JZVNbnfrPMQaOH7Cg.png)
...
![Screenshot showing how to add a secret to the GitHub repository.](/static/images/blog/contents/1_EAtjRMXaBgLpoIo7va1gBQ.png)
...
![Screenshot showing the $web folder in the storage account.](/static/images/blog/contents/1_wzVK3QVvnvn1emneH-EukA.png)
...
![Screenshot showing the static site up and running.](/static/images/blog/contents/1_IEw5tViqDDfBxKDSWVPKCw.png)
