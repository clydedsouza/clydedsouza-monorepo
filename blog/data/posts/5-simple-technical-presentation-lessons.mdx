...
![GIF of a short clip from my session from .NET Conference 2020](/static/images/blog/contents/1_dyqtsonvFnbzZyGAYV9Whg.gif)
...
![GIF of a short clip from my session from .NET Conference 2020](/static/images/blog/contents/1_UAOzg0-vJNEhwChuzJAB2g.gif)
...
![GIF of a short clip from my session from .NET Conference 2020](/static/images/blog/contents/1_WbChJKTO3eAifWC7OdScGw.gif)
