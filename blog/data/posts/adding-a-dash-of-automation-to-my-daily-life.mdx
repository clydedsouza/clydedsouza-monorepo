...
![A visual representation of the workflow I use](https://cdn-images-1.medium.com/max/1200/1*K9kL_X6G20bwMhQDrAmTEA.jpeg)
...
![Image annotating the steps to create a new flow](https://cdn-images-1.medium.com/max/800/1*SXnhARIJPqNZaafkIrVQnw.png)
...
![Image showing the configuration options for a new email trigger](https://cdn-images-1.medium.com/max/800/1*SQPvMRfUaeBpS8ocYv1RJA.png)
...
![GIF showing how to add a step in Microsoft Power Automate](https://cdn-images-1.medium.com/max/800/1*_Ep2VVSp2oLbMafuhcGh4A.gif)
...
![Image showing how to configure Dynamic content in Automate](https://cdn-images-1.medium.com/max/800/1*WIDSoG1j_1RFyQnOnMgPzQ.png)
...
![Image showing how to add receipients email address into the step condition](https://cdn-images-1.medium.com/max/800/1*pfaCUVt83XnxFLO_25pOvw.png)
...
![GIF showing how to add the Html-to-text conversion task as an action](https://cdn-images-1.medium.com/max/800/1*OipB0NaqH02JmInHyAXHLQ.gif)
...
![Image showing how to configure the Html-to-text action in Automate](https://cdn-images-1.medium.com/max/800/1*7E4ewBGhLJ7XVnRADF6wmQ.png)
...
![Image showing how to configure Google Calendar event action in Automate](https://cdn-images-1.medium.com/max/800/1*hCzxS5r80TOLiaTRahaMlw.png)
...
![Image showing how to add an Expression in Microsoft Power Automate](https://cdn-images-1.medium.com/max/800/1*6YNswKJxgbfqDaCdLobhig.png)
...
![Image showing how to configure the create Trello card action](https://cdn-images-1.medium.com/max/800/1*CZ5UnWHFCCXoA3YXSz1iaQ.png)
...
![A GIF of the final results of this exercise](https://cdn-images-1.medium.com/max/1200/1*rusirwp_gS1kjWpKJZ5YLw.gif)
