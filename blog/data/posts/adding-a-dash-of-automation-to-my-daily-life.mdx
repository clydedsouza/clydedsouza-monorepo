...
![A visual representation of the workflow I use](/static/images/blog/contents/1_K9kL_X6G20bwMhQDrAmTEA.jpeg)
...
![Image annotating the steps to create a new flow](/static/images/blog/contents/1_SXnhARIJPqNZaafkIrVQnw.png)
...
![Image showing the configuration options for a new email trigger](/static/images/blog/contents/1_SQPvMRfUaeBpS8ocYv1RJA.png)
...
![GIF showing how to add a step in Microsoft Power Automate](/static/images/blog/contents/1__Ep2VVSp2oLbMafuhcGh4A.gif)
...
![Image showing how to configure Dynamic content in Automate](/static/images/blog/contents/1_WIDSoG1j_1RFyQnOnMgPzQ.png)
...
![Image showing how to add receipients email address into the step condition](/static/images/blog/contents/1_pfaCUVt83XnxFLO_25pOvw.png)
...
![GIF showing how to add the Html-to-text conversion task as an action](/static/images/blog/contents/1_OipB0NaqH02JmInHyAXHLQ.gif)
...
![Image showing how to configure the Html-to-text action in Automate](/static/images/blog/contents/1_7E4ewBGhLJ7XVnRADF6wmQ.png)
...
![Image showing how to configure Google Calendar event action in Automate](/static/images/blog/contents/1_hCzxS5r80TOLiaTRahaMlw.png)
...
![Image showing how to add an Expression in Microsoft Power Automate](/static/images/blog/contents/1_6YNswKJxgbfqDaCdLobhig.png)
...
![Image showing how to configure the create Trello card action](/static/images/blog/contents/1_CZ5UnWHFCCXoA3YXSz1iaQ.png)
...
![A GIF of the final results of this exercise](/static/images/blog/contents/1_rusirwp_gS1kjWpKJZ5YLw.gif)
