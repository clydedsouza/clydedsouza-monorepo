...
images: ['/static/images/blog/azure.png']
---

<InlineImage
  src="/static/images/blog/azure.png"
...
![Image showing Azure service connection configuration form](https://cdn-images-1.medium.com/max/800/1*Q5QSSjTjcwPOdkaY2izAEg.gif)
...
![Image showing Azure service connection subscription details](https://cdn-images-1.medium.com/max/800/1*yiprYt6GRRnqvzcwTCDcDw.png)
...
![Image show Azure portal subscription details](https://cdn-images-1.medium.com/max/800/1*N4sezJdxwQLVPEeIk5_wqA.png)
...
![Image showing Azure service connection authentication section](https://cdn-images-1.medium.com/max/800/1*zH4RnUk_XB7bFm5BIdHrWg.png)
...
![Image showing steps to register a new app in Azure](https://cdn-images-1.medium.com/max/800/1*NybGUnjbF246E8BptgcNvg.png)
...
![Image showing steps to register an app in Azure](https://cdn-images-1.medium.com/max/800/1*YN7hMZl9hQb9ixXac5UgKg.png)
...
![Image showing how to get the application ID and directory ID](https://cdn-images-1.medium.com/max/800/1*1wCEvKUOkcdKqyURw9wcwQ.png)
...
![Image showing how to generate a new client secret](https://cdn-images-1.medium.com/max/800/1*37uh2FFdsasyQKMwkdtd5Q.gif)
...
![Image showing the result of validating the connection from Azure DevOps to Azure](https://cdn-images-1.medium.com/max/800/1*hcJE2Fx0JDrwGGSiCY5eaA.png)
...
![Image showing how to add the app as a contributor in Azure](https://cdn-images-1.medium.com/max/800/1*NJdeBroHhMI8oPFRUsFxfg.png)
...
![Image showing the result of re-validating the connection from Azure DevOps to Azure](https://cdn-images-1.medium.com/max/800/1*cTyUywjY_kUgmS5sRA9GxA.png)
...
![Image showing basic details for the Azure service connection](https://cdn-images-1.medium.com/max/800/1*C_thap0WL25iSTSXg5_Lsw.png)
...
![Image showing where the Azure service connection is used](https://cdn-images-1.medium.com/max/800/1*9RCdygdIVaRSmmWVvilRMg.png)
...
![Download ‘Mama, tell me a story’ from Amazon](https://cdn-images-1.medium.com/max/800/0*Ouw0aqoWyKMvlcdx.png)

Download ‘Mama, tell me a story’ from [Amazon](http://bit.ly/MamaTellMeAStory)

I’ve written a children’s bedtime story book titled ‘Mama, tell me a story’. Download my book from [Amazon](http://bit.ly/MamaTellMeAStory) today. 🙂
