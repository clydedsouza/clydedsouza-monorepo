...
![Image showing Azure service connection configuration form](/static/images/blog/contents/1_Q5QSSjTjcwPOdkaY2izAEg.gif)
...
![Image showing Azure service connection subscription details](/static/images/blog/contents/1_yiprYt6GRRnqvzcwTCDcDw.png)
...
![Image show Azure portal subscription details](/static/images/blog/contents/1_N4sezJdxwQLVPEeIk5_wqA.png)
...
![Image showing Azure service connection authentication section](/static/images/blog/contents/1_zH4RnUk_XB7bFm5BIdHrWg.png)
...
![Image showing steps to register a new app in Azure](/static/images/blog/contents/1_NybGUnjbF246E8BptgcNvg.png)
...
![Image showing steps to register an app in Azure](/static/images/blog/contents/1_YN7hMZl9hQb9ixXac5UgKg.png)
...
![Image showing how to get the application ID and directory ID](/static/images/blog/contents/1_1wCEvKUOkcdKqyURw9wcwQ.png)
...
![Image showing how to generate a new client secret](/static/images/blog/contents/1_37uh2FFdsasyQKMwkdtd5Q.gif)
...
![Image showing the result of validating the connection from Azure DevOps to Azure](/static/images/blog/contents/1_hcJE2Fx0JDrwGGSiCY5eaA.png)
...
![Image showing how to add the app as a contributor in Azure](/static/images/blog/contents/1_NJdeBroHhMI8oPFRUsFxfg.png)
...
![Image showing the result of re-validating the connection from Azure DevOps to Azure](/static/images/blog/contents/1_cTyUywjY_kUgmS5sRA9GxA.png)
...
![Image showing basic details for the Azure service connection](/static/images/blog/contents/1_C_thap0WL25iSTSXg5_Lsw.png)
...
![Image showing where the Azure service connection is used](/static/images/blog/contents/1_9RCdygdIVaRSmmWVvilRMg.png)
...
![Download ‘Mama, tell me a story’ from Amazon](/static/images/blog/contents/0_Ouw0aqoWyKMvlcdx.png)
